...
class Summary_taxes extends Report
{
    ...
    $CI =& get_instance();
		...
		if ($this->settings['display'] == 'tabular')
		{
			$input_data = Report::get_common_report_input_data(TRUE);
                        ...
                        {
                                array_splice($input_params,3,0,array(array('view' => 'dropdown','dropdown_label' => lang('reports_sale_source'),'dropdown_name' => 'sale_source','dropdown_options' => array('all' => lang('reports_all'), 'in_person' => lang('reports_in_person_sales'), 'online' => lang('reports_online_sales')),'dropdown_selected_value' => 'all')));
                        }
		}
	...
	public function getSummaryData()
	{
		...
		$this->db->from('sales');
                ...
                if(isset($this->params['sale_source']) && $this->params['sale_source'] !== 'all')
                {
                        $this->db->where('is_ecommerce', $this->params['sale_source'] == 'online' ? 1 : 0);
                }
