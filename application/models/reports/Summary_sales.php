    ...
    $CI =& get_instance();
		...
		if ($this->settings['display'] == 'tabular')
		{
			$input_data = Report::get_common_report_input_data(TRUE);
                        ...
                        {
                                array_splice($input_params,6,0,array(array('view' => 'dropdown','dropdown_label' => lang('reports_sale_source'),'dropdown_name' => 'sale_source','dropdown_options' => array('all' => lang('reports_all'), 'in_person' => lang('reports_in_person_sales'), 'online' => lang('reports_online_sales')),'dropdown_selected_value' => 'all')));
                        }
                }
                elseif ($this->settings['display'] == 'graphical')
                {
                        ...
                        if($this->config->item('ecommerce_platform'))
                        {
                                array_splice($input_params,5,0,array(array('view' => 'dropdown','dropdown_label' => lang('reports_sale_source'),'dropdown_name' => 'sale_source','dropdown_options' => array('all' => lang('reports_all'), 'in_person' => lang('reports_in_person_sales'), 'online' => lang('reports_online_sales')),'dropdown_selected_value' => 'all')));
                        }
