...
class Summary_timeclock extends Report
{
	...
	public function getDataColumns()
	{
		...
		$columns = array();
               ...
               $columns[] = array('data'=>lang('common_employees_number'), 'align'=> 'left');
	...
	public function getOutputData()
	{
		...
		$employee_id = $this->params['employee_id'];
               ...
               foreach($report_data as $row)
               {
                       ...
                       $data_row[] = array('data'=>$row['employee_number'], 'align' => 'left');
	...
	public function getData()
	{
		$location_ids = self::get_selected_location_ids();
               $this->db->select('employees_time_clock.*, people.first_name, people.last_name, employees.employee_number');
		...
		$data = $this->db->get()->result_array();
               ...
               foreach($data as $row)
               {
                       ...
                       {
                               $return[$row['employee_id']] = array('first_name' => $row['first_name'], 'last_name' => $row['last_name'], 'employee_number' => $row['employee_number'], 'hours' => 0, 'total' => 0);
                       }
