...
class Summary_store_accounts extends Report
{
	...
	public function getInputData()
	{
		...
		'input_params' => array(
				array('view' => 'date'),
				array('view' => 'credit_limit_total'),
				array('view' => 'balance_total'),
	...
	public function getData()
	{
		...
		if ($this->params['total_spent_condition_credit_limit'] != 'any' && is_numeric($this->params['credit_limit']))
		{
			switch($this->params['total_spent_condition_credit_limit'])
			{
				case $this->params['total_spent_condition_credit_limit'] == 'greater_than':
					$condition_credit_limit = '>';
				break;

				case $this->params['total_spent_condition_credit_limit'] == 'less_than':
					$condition_credit_limit = '<';
				break;

				case $this->params['total_spent_condition_credit_limit'] == 'equal_to':
					$condition_credit_limit = '=';
				break;
		...
		if ($this->params['total_spent_condition_balance'] != 'any' && is_numeric($this->params['balance']))
		{
			switch($this->params['total_spent_condition_balance'])
			{
				case $this->params['total_spent_condition_balance'] == 'greater_than':
					$condition_balance = '>';
				break;

				case $this->params['total_spent_condition_balance'] == 'less_than':
					$condition_balance = '<';
				break;

				case $this->params['total_spent_condition_balance'] == 'equal_to':
					$condition_balance = '=';
				break;
		...
		{		
			...
			if ($this->params['total_spent_condition_credit_limit'] != 'any' && is_numeric($this->params['credit_limit']))
			{
				$this->db->where('customers.credit_limit '.$condition_credit_limit.' '.$this->params['credit_limit']);
			}
			
			if ($this->params['total_spent_condition_balance'] != 'any' && is_numeric($this->params['balance']))
			{
				$this->db->where('customers.balance '.$condition_balance.' '.$this->params['balance']);
			}
