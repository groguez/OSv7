...
class Summary_payments extends Report
{
	...
	public function getSummaryData()
	{
		...
		foreach($payment_data as $payment)
		{
			...
			if (in_array($payment['payment_type'], $store_account_in_all_languages))
			{
				$total_store_account_charges+=$payment['payment_amount'];
			}
		}
		
		
		$return['total_received'] = $return['total'] - $total_store_account_charges;
