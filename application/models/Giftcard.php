...
class Giftcard extends MY_Model
{
	...
	*/
	...
	/*
	Get a giftcard ID given a giftcard number
	*/
	function exist_giftcard_number($giftcard_number, $deleted = false)
	{
		$this->db->reset_query();
		$this->db->select('giftcards.giftcard_id as giftcard_id');
		$this->db->from('giftcards');
		$this->db->where('giftcard_number', $giftcard_number);
	...
	/*
	Get a giftcard ID given a giftcard number & pin
	*/
	function get_giftcard_id_from_number_pin($giftcard_number, $giftcard_pin, $deleted = false)
	{
		$this->db->reset_query();
		$this->db->select('giftcards.giftcard_id as giftcard_id');
		$this->db->from('giftcards');
		$this->db->where('giftcard_number', $giftcard_number);
		$this->db->where('giftcard_pin', $giftcard_pin);
