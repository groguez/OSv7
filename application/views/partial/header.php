...
<head>
	...
	$.support.transition = false;
		...
		{
                               <?php if ($this->config->item('hover_to_expand_sub_modules')) { ?>
	...
	<div class="wrapper <?php echo $this->uri->segment(1)=='sales' || $this->uri->segment(1)=='receivings' || $this->config->item('always_minimize_menu')  ? 'mini-bar sales-bar' : ''; ?>">
		<div class="left-bar hidden-print" >
			...
			<!-- admin-logo -->
                       ...
                       <ul class="list-unstyled menu-parent" id="mainMenu">
                               <?php $module_menu_overrides = $this->config->item('module_menu_overrides') ? unserialize($this->config->item('module_menu_overrides')) : array(); ?>
							...
							<?php if ($this->Employee->has_module_permission('items', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
								<li class="<?php echo $active_submenu_link;?>" <?php echo array_search('items', $disable_modules) === false ? '': 'style="display: none;"' ?>>
                                                                       <a href="<?php echo site_url('items'); ?>"><i class="icon ti-harddrive"></i>
                                                                              <?php echo isset($module_menu_overrides['items']) && $module_menu_overrides['items'] ? H($module_menu_overrides['items']) : lang("module_items"); ?>
                                                                       </a>
								</li>
							<?php } ?>
							...
							<?php if ($this->Employee->has_module_permission('item_kits', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
								<li <?php echo array_search('item_kits', $disable_modules) === false ? '': 'style="display: none;"' ?>>
                                                                       <a href="<?php echo site_url('item_kits'); ?>"><i class="icon ti-harddrives"></i>
                                                                              <?php echo isset($module_menu_overrides['item_kits']) && $module_menu_overrides['item_kits'] ? H($module_menu_overrides['item_kits']) : lang("module_item_kits"); ?>
                                                                       </a>
								</li>
							<?php } ?>
							...
							<?php if ($this->Employee->has_module_permission('price_rules', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
								<li <?php echo array_search('price_rules', $disable_modules) === false ? '': 'style="display: none;"' ?>>
                                                                       <a href="<?php echo site_url('price_rules'); ?>"><i class="ion-ios-pricetags-outline"></i>
                                                                              <?php echo isset($module_menu_overrides['price_rules']) && $module_menu_overrides['price_rules'] ? H($module_menu_overrides['price_rules']) : lang("module_price_rules"); ?>
                                                                       </a>
								</li>
							<?php } ?>
					...
					<li class="has_sub_menu">
						...
						<a tabindex = "-1" href=""  class="waves-effect waves-light" data-toggle="collapse" aria-expanded="false">
							<i class="icon ti-receipt"></i>
                                                       <span class="text"><?php echo isset($module_menu_overrides['invoices']) && $module_menu_overrides['invoices'] ? H($module_menu_overrides['invoices']) : lang("module_invoices") ?></span>
							<span class="dropdown pull-right-container">
                    <i class="icon ti-angle-down"></i>
                </span>
						</a>
					...
					<li class="has_sub_menu">
						...
						<a tabindex = "-1" href=""  class="waves-effect waves-light" data-toggle="collapse" aria-expanded="false">
							<i class="icon ti-user"></i>
                                                       <span class="text"><?php echo isset($module_menu_overrides['customers']) && $module_menu_overrides['customers'] ? H($module_menu_overrides['customers']) : lang("module_customers") ?></span>
							<span class="dropdown pull-right-container">
                    <i class="icon ti-angle-down"></i>
                </span>
						</a>
					...
					<li <?php echo $module->module_id==$this->uri->segment(1)  ? 'class="active ' . $module->module_id . '"' : 'class="' . $module->module_id . '"'; ?>
						...
						<a tabindex = "-1" href="<?php echo site_url("$module->module_id");?>"  class="waves-effect waves-light">
							<i class="<?php echo $module->icon; ?>"></i>
                                                       <span class="text"><?php echo isset($module_menu_overrides[$module->module_id]) && $module_menu_overrides[$module->module_id] ? H($module_menu_overrides[$module->module_id]) : lang("module_".$module->module_id) ?></span>
						</a>
					</li>
				<?php 
				} } 
				...
				<li>
					<a tabindex = "-1" href="#" onclick="openZendeskChat(); return false;">
						<i class="icon ti-help"></i>
						<span class="text"><?php echo lang("common_support") ?></span>
					</a>
				</li>				
		...
		<div class="overlay hidden-print"></div>			
			<div class="top-bar hidden-print">				
				<nav class="navbar navbar-default top-bar" style="<?php echo isset($location_color) && $location_color ? 'background-color: '.$location_color.' !important': ''; ?>">
					...
					<li class="quick_button dropdown btn-sm btn-quick">
							...
							<?php if($this->Employee->has_module_action_permission('appointments', 'add', $employee_id)) { ?>
							<li>
								<a tabindex = "-1" id="support_link" href="<?php echo site_url('appointments/view/-1/'); ?>">
									<span class="text"><?php echo lang('appointments_new');?></span>
								</a>				
						</li>
						<?php } ?>
							</ul>
					...
					<?php  if(!$this->config->item('hide_latest_updates_in_header') && !is_on_demo_host()){ ?>		
							<li class="dropdown hidden-xs" id="canny_feedback_container">
								<a class="hidden-xs" data-canny-changelog href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="ion-information icon-notification" style="vertical-align: middle;"></i></a>
							</li>
					...
					<?php } ?>
						...
						<li class="dropdown">
							...
							<li>
									<a tabindex = "-1" id="support_link" target="_blank" href="#" onclick="openZendeskChat(); return false;"><i class="ion-help-buoy"></i><span class="text"><?php echo lang('common_support'); ?></span></a>									
							</li>
								...
								<?php if ($this->Location->get_info_for_key('blockchyp_api_key') && $this->Employee->has_module_action_permission('sales', 'view_edit_transaction_history', $this->Employee->get_logged_in_employee_info()->person_id)) {?>				
									<li>
									<a target="_blank" tabindex = "-1" title="" href="/coreclear/"><i class="ion-ios-world"></i><span class="text"><?php echo lang('sales_coreclear_portal'); ?></span></a>
