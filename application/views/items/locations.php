			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-md-9 col-lg-10 form-text">
						<?php echo form_input(array(
							'name'=>'locations['.$location->location_id.'][limited_sales_quantity]',
							'placeholder' => to_quantity(null, FALSE),
							'value'=> $location_items[$location->location_id]->item_id !== '' &&  $location_items[$location->location_id]->limited_sales_quantity !== NULL ? to_quantity($location_items[$location->location_id]->limited_sales_quantity): '',
							'class'=>'form-control'
							)
						);?>
					</div>
					...
					<tbody>
						<?php foreach($item_variations as $item_variation_id => $item_variation) { ?>
								<tr>
									...
									<td><input type="text" class="form-control form-inps" size="5" name="locations[<?php echo $location->location_id;?>][item_variations][<?php echo $item_variation_id; ?>][limited_sales_quantity]" value='<?php echo isset($location_variations[$location->location_id][$item_variation_id]['limited_sales_quantity']) ? H(to_quantity($location_variations[$location->location_id][$item_variation_id]['limited_sales_quantity'])) : ''; ?>' /></td>
