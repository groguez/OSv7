...
echo form_open('items/print_qr_barcodes/'.$item_info->item_id,array('id'=>'item_form','class'=>'form-horizontal'), $hidden); ?>
		...
		<div class="col-md-12">
			<div class="panel panel-piluku">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<?php echo form_label(lang('items_number_of_qr_barcodes').':', null,array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							...
							?> 
	 						...
	 						<?php echo form_dropdown('items_number_of_qr_barcodes', $numbers,
	 						1 , 'class="form-control" id="items_number_of_qr_barcodes"');
							?>
					...
					<div class="form-group">
						<?php echo form_label(lang('items_qrcode_labels').':', null,array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<?php echo form_submit('qr_code_labels_action',lang("items_qrcode_labels"),'class="btn btn-primary"'); ?>
						</div>
					</div>
				
					<div class="form-group">
						<?php echo form_label(lang('items_qrcode_sheet').':', null,array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
						<div class="col-sm-9 col-md-9 col-lg-10">
							<?php echo form_submit('qr_code_sheet_action',lang("items_qrcode_sheet"),'class="btn btn-primary" id="generate_qr_code_sheet"'); ?>
						</div>
					</div>
								...
								<table class="table table-striped table-hover custom-table">
									...
									<tbody>
										<?php foreach($item_variations as $item_variation_id => $item_variation) { ?>
											<tr>
												<td><input type="text" class="form-control number_of_barcodes_variations" name="item_variations_number_of_qr_barcodes[<?php echo $item_variation_id; ?>]" ></td>
					...
					<div class="modal fade skip-labels" id="skip-labels-qr-code" role="dialog" aria-labelledby="skipLabels" aria-hidden="true">
					    <div class="modal-dialog customer-recent-sales">
					      	<div class="modal-content">
						        ...
						        <div class="modal-body">
									<input type="text" class="form-control text-center" name="skip" id="skip" placeholder="<?php echo lang('common_skip_labels') ?>">
									<?php echo form_submit('qr_code_sheet_action',lang("common_submit"),'class="btn btn-block btn-primary"'); ?>
...
<script type='text/javascript'>
	...
	$("#generate_qr_code_sheet").click(function()
	{
