		...
		<div class="panel panel-piluku">
	      ...
	      <h3 class="panel-title"><i class="ion-cash"></i> <?php echo lang("common_pricing"); ?> <small>(<?php echo lang('common_fields_required_message'); ?>)</small></h3>
			...
			<div class="panel-body">
				...
				<?php
				if ($cc_processor_class_name == 'CORECLEARBLOCKCHYPPROCESSOR' || $cc_processor_class_name == 'VALORPROCESSOR'
					|| $this->config->item('customers_store_accounts')
				)
				{
				?>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-md-9 col-lg-10">
						<?php echo form_checkbox(array(
							...
							'class'=>'delete-checkbox',
							'value'=>1,
							'checked'=>(isset($item_info->disable_from_price_rules) && $item_info->disable_from_price_rules) ? 1 : 0,
						));?>
				...
				<div class="form-group">
					<?php echo form_label(lang('common_item_non_profit_sale').':', 'non_profit_sale',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
					<div class="col-sm-9 col-md-9 col-lg-10">
						<?php echo form_checkbox(array(
							...
							'class'=>'delete-checkbox',
							'value'=>1,
							'checked'=>( isset($item_info->non_profit_sale) && $item_info->non_profit_sale ) ? 1 : 0,
						));?>
