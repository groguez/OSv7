				...
				<div class="panel-body ">
					<div class="user-badge">
						...
						<ul class="list-inline pull-right">
                            <li><a target="_blank" href="<?php echo site_url('reports/generate/specific_supplier?report_type=simple&report_date_range_simple=ALL_TIME&supplier_id='.$person_info->person_id.'&sale_type=all&export_excel=0'); ?>" class="btn btn-success"><?php echo lang('common_view_report'); ?></a></li>
