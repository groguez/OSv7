...
<div class="text-center">					
	...
	if($this->config->item("ecommerce_platform") == 'shopify')
	{
		...
		if ($ecom_model->needs_more_permissions())
		{
			?>
			<div class="alert alert-danger" style="text-align: left;">
				<strong><?php echo lang('home_shopify_needs_more_permissions'); ?></strong>
				<br />
				<a href="<?php echo site_url('ecommerce/oauth_shopify/home');?>" class="btn btn-success" id="shopify_oauth_connectt"><?php echo lang('common_go'); ?></a>
		    </div>
