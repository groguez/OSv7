...
<script type="text/javascript">
	...
	$(document).ready(function() 
	{
		...
		$("#search_type_id").select2({dropdownAutoWidth : true});
			...
			<?php echo form_open("$controller_name/search",array('id'=>'search_form', 'autocomplete'=> 'off')); ?>
					<div class="search no-left-border">
						<ul class="list-inline">
							...
							?>
							<li class="hidden-xs">
								<?php echo lang('common_search') . ' ' . lang('common_type'); ?>: 	
								<?php echo form_dropdown('search_type_id', $search_type, $selected_search_type ?? $search_type[0], 'class="" id="search_type_id"'); ?>
							</li>
							<?php
							}
							?>
