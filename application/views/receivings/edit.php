		...
		<div class="panel piluku-panel">
			...
			<div class="panel-body">
					...
					<?php } else { ?>
						...
						<?php 
						 if (( $this->Employee->has_module_action_permission('receivings', 'edit_receiving', $this->Employee->get_logged_in_employee_info()->person_id)) && (empty($currentReceivingAccoutingId))) {
