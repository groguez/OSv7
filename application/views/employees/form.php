	...
	<div class="col-md-12">
				...
				<div class="panel-body ">
					<div class="user-badge">
						...
						<ul class="list-inline pull-right">
                                                       <li><a target="_blank" href="<?php echo site_url('reports/generate/specific_employee?employee_type=logged_in_employee&report_type=simple&report_date_range_simple=ALL_TIME&employee_id=' . $person_info->person_id . '&sale_type=all&export_excel=0'); ?>" class="btn btn-success"><?php echo lang('common_view_report'); ?></a></li>
		...
		<div class="panel panel-piluku">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<?php echo form_label(lang('common_max_discount_percent_and_calculate_when_doing_flat') . ':', 'max_discount_percent', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
					<div class="col-sm-9 col-md-9 col-lg-10">
						<div class="input-group">
							<?php echo form_input(array(
								...
								'class' => 'form-control',
								'value' => $person_info->max_discount_percent ? to_quantity($person_info->max_discount_percent, false) : '',
							)); ?>
					...
					<div class="col-sm-9 col-md-9 col-lg-10">
						<div class="input-group">
							<?php echo form_input(array(
								...
								'class' => 'form-control',
								'value' => $person_info->commission_percent ? to_quantity($person_info->commission_percent, FALSE) : '',
							)); ?>
							<span class="input-group-addon">%</span>
						</div>
					</div>
