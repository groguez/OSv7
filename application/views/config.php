		...
		<div class="col-xs-12 col-md-3">
			<ul class="nav nav-pills nav-stacked custom-pills config-nav">
				...
				<li role="presentation"><a href="#store_accounts" data-toggle="pill"><?php echo lang("config_store_accounts_info"); ?></a></li>
                                ...
                                <li role="presentation"><a href="#rename_modules" data-toggle="pill"><?php echo lang("config_rename_left_menu"); ?></a></li>
											...
											<div class="col-md-9 col-sm-9 col-lg-10">
												<div class="table-responsive">
													<table id="tax_classes" class="table">
														...
														<tbody>
															<?php
															if (count($tax_classes) == 1 && isset($tax_classes[1]['taxes']) && count($tax_classes[1]['taxes']) == 0)
															{
																$tax_classes[1]['taxes'][] = array(
																	'id' => -1,
							...
							<div class="panel panel-piluku">
								...
								<div id="payment_types_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
									<div class="panel-body">
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_payment')) ?>">	
											<?php echo form_label(lang('config_show_debit_payment_option_when_using_integrated_credit_card_processing').':', 'show_debit_payment_option_when_using_integrated_credit_card_processing',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'show_debit_payment_option_when_using_integrated_credit_card_processing',
												'id'=>'show_debit_payment_option_when_using_integrated_credit_card_processing',
												'value'=>'show_debit_payment_option_when_using_integrated_credit_card_processing',
												'checked'=>$this->config->item('show_debit_payment_option_when_using_integrated_credit_card_processing')));?>
												<label for="show_debit_payment_option_when_using_integrated_credit_card_processing"><span></span></label>
											</div>
										</div>
							...
							<div class="panel panel-piluku">
								...
								<div id="sales_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
									<div class="panel-body">
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_sales')) ?>">	
											<?php echo form_label(lang('config_update_base_unit_price_from_units').':', 'update_base_unit_price_from_units',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'update_base_unit_price_from_units',
												'id'=>'update_base_unit_price_from_units',
												'value'=>'update_base_unit_price_from_units',
												'checked'=>$this->config->item('update_base_unit_price_from_units')));?>
												<label for="update_base_unit_price_from_units"><span></span></label>
											</div>
										</div>					
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_sales')) ?>">	
											<?php echo form_label(lang('config_enable_giftcard_security').':', 'enable_giftcard_security', array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'enable_giftcard_security',
												'id'=>'enable_giftcard_security',
												'value'=>'1',
												'checked'=>$this->config->item('enable_giftcard_security')));?>
												<label for="enable_giftcard_security"><span></span></label>
											</div>
										</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_sales')) ?>">	
											<?php echo form_label(lang('config_inventory_post_date_is_always_sale_date').':', 'inventory_post_date_is_always_sale_date',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'inventory_post_date_is_always_sale_date',
												'id'=>'inventory_post_date_is_always_sale_date',
												'value'=>'1',
												'checked'=>$this->config->item('inventory_post_date_is_always_sale_date')));?>
												<label for="inventory_post_date_is_always_sale_date"><span></span></label>
											</div>
										</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_allow_customers_to_pay_suspended_sales_online')) ?>">
											<?php echo form_label(lang('config_allow_customers_to_pay_suspended_sales_online').':', 'allow_customers_to_pay_suspended_sales_online',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
												<?php echo form_checkbox(array(
													'name' 		=> 'allow_customers_to_pay_suspended_sales_online',
													'id' 		=> 'allow_customers_to_pay_suspended_sales_online',
													'value' 	=> 'allow_customers_to_pay_suspended_sales_online',
													'checked' 	=> $this->config->item('allow_customers_to_pay_suspended_sales_online'))); ?>
												<label for="allow_customers_to_pay_suspended_sales_online"><span></span></label>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="panel panel-piluku">
								...
								<div id="suspended_sales_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
									<div class="panel-body">
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_suspended_layaways')) ?>">	
											<?php echo form_label(lang('config_do_not_suspended_receipt_created_by_someone_else').':', 'do_not_suspended_receipt_created_by_someone_else',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'do_not_suspended_receipt_created_by_someone_else',
												'id'=>'do_not_suspended_receipt_created_by_someone_else',
												'value'=>'1',
												'checked'=>$this->config->item('do_not_suspended_receipt_created_by_someone_else')));?>
												<label for="do_not_suspended_receipt_created_by_someone_else"><span></span></label>
											</div>
										</div>
							...
							<div class="panel panel-piluku">
								...
								<div id="receipt_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
									<div class="panel-body">
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_receipt')) ?>">	
											<?php echo form_label(lang('config_show_email_of_company_on_receipt').':', 'show_email_of_company_on_receipt',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'show_email_of_company_on_receipt',
												'id'=>'show_email_of_company_on_receipt',
												'value'=>'show_email_of_company_on_receipt',
												'checked'=>$this->config->item('show_email_of_company_on_receipt')));?>
												<label for="show_email_of_company_on_receipt"><span></span></label>
											</div>
										</div>
										
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_receipt')) ?>">	
											<?php echo form_label(lang('config_show_weight_and_dim_on_receipt').':', 'show_weight_and_dim_on_receipt',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'show_weight_and_dim_on_receipt',
												'id'=>'show_weight_and_dim_on_receipt',
												'value'=>'show_weight_and_dim_on_receipt',
												'checked'=>$this->config->item('show_weight_and_dim_on_receipt')));?>
												<label for="show_weight_and_dim_on_receipt"><span></span></label>
											</div>
										</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_receipt')) ?>">	
											<?php echo form_label(lang('config_show_line_item_sales_person_on_receipt').':', 'show_line_item_sales_person_on_receipt',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'show_line_item_sales_person_on_receipt',
												'id'=>'show_line_item_sales_person_on_receipt',
												'value'=>'show_line_item_sales_person_on_receipt',
												'checked'=>$this->config->item('show_line_item_sales_person_on_receipt')));?>
												<label for="show_line_item_sales_person_on_receipt"><span></span></label>
											</div>
										</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_receipt')) ?>">	
											<?php echo form_label(lang('config_hide_price_rule_on_receipt').':', 'hide_price_rule_on_receipt',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'hide_price_rule_on_receipt',
												'id'=>'hide_price_rule_on_receipt',
												'value'=>'1',
												'checked'=>$this->config->item('hide_price_rule_on_receipt')));?>
												<label for="hide_price_rule_on_receipt"><span></span></label>
											</div>
										</div>
...
<label for="disable_variation_popup_in_receivings"><span></span></label>
                                       ...
                                       <div class="form-group" data-keyword="<?php echo H(lang('config_keyword_receipt')) ?>">
                                       <?php echo form_label(lang('config_always_show_expire_date_in_recv').':', 'always_show_expire_date_in_recv',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
                                       <div class="col-sm-9 col-md-9 col-lg-10">
                                       <?php echo form_checkbox(array(
                                       'name'=>'always_show_expire_date_in_recv',
                                       'id'=>'always_show_expire_date_in_recv',
                                       'value'=>'always_show_expire_date_in_recv',
                                       'checked'=>$this->config->item('always_show_expire_date_in_recv')));?>
                                       <label for="always_show_expire_date_in_recv"><span></span></label>
                                       </div>
                                       </div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_override_fulfillment_sheet_title')) ?>">	
											<?php echo form_label(lang('config_override_fulfillment_sheet_title').':', 'override_fulfillment_sheet_title',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_input(array(
												'class'=>'form-control form-inps',
												'name'=>'override_fulfillment_sheet_title',
												'id'=>'override_fulfillment_sheet_title',
												'size'=> 40,
												'value'=>$this->config->item('override_fulfillment_sheet_title')));?>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="panel panel-piluku">
								...
								<div id="barcodes_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
									<div class="panel-body">
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_barcodes')) ?>">	
											<?php echo form_label(lang('config_qr_code_price_include_tax').':', 'qr_code_price_include_tax',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'qr_code_price_include_tax',
												'id'=>'qr_code_price_include_tax',
												'value'=>'qr_code_price_include_tax',
												'checked'=>$this->config->item('qr_code_price_include_tax')));?>
												<label for="qr_code_price_include_tax"><span></span></label>
											</div>
										</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_barcodes')) ?>">	
											<?php echo form_label(lang('config_hide_price_on_qr_codes').':', 'hide_price_on_qr_codes',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'hide_price_on_qr_codes',
												'id'=>'hide_price_on_qr_codes',
												'value'=>'hide_price_on_qr_codes',
												'checked'=>$this->config->item('hide_price_on_qr_codes')));?>
												<label for="hide_price_on_qr_codes"><span></span></label>
											</div>
										</div>
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_barcodes')) ?>">	
											<?php echo form_label(lang('config_hide_name_on_qr_codes').':', 'hide_name_on_qr_codes',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'hide_name_on_qr_codes',
												'id'=>'hide_name_on_qr_codes',
												'value'=>'hide_name_on_qr_codes',
												'checked'=>$this->config->item('hide_name_on_qr_codes')));?>
												<label for="hide_name_on_qr_codes"><span></span></label>
											</div>
										</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_barcodes')) ?>">	
											...
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php
												echo form_dropdown('scale_format', array(
												'scale_0'   => lang('config_scale_0'),
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_barcodes')) ?>">	
											<?php echo form_label('Scale Barcode Custom Format'.':', 'scale_format',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php

												$scale_custom_format = $this->config->item('scale_custom_format')? unserialize( $this->config->item('scale_custom_format')) : null;
												if($this->config->item('enable_scale')){
													if($this->config->item('scale_format') == 'scale_1'){
														$scale_custom_format = array(
															0 =>	"null",
															1 =>	"item_number",
															2 =>	"item_number",
															3 =>	"item_number",
													...
													}else if($this->config->item('scale_format') == 'scale_2'){
														$scale_custom_format = array(
															0 =>	"null",
															1 =>	"item_number",
															2 =>	"item_number",
													...
													}else if($this->config->item('scale_format') == 'scale_3'){
														$scale_custom_format = array(
															0 =>	"null",
															1 =>	"item_number",
															2 =>	"item_number",
													...
													}else if($this->config->item('scale_format') == 'scale_4'){
														$scale_custom_format = array(
															0 =>	"null",
															1 =>	"item_number",
															2 =>	"item_number",
													...
													}else if($this->config->item('scale_format') == 'scale_5'){
														$scale_custom_format = array(
															0 =>	"null",
															1 =>	"item_number",
															2 =>	"item_number",
													...
													}else if($this->config->item('scale_format') == 'scale_6'){
														$scale_custom_format = array(
															0 =>	"null",
															1 =>	"null",
															2 =>	"item_number",
													...
													}else if($this->config->item('scale_format') == 'scale_7'){
														$scale_custom_format = array(
															0 =>	"null",
															1 =>	"null",
															2 =>	"item_number",
													...
													}else if($this->config->item('scale_format') == 'scale_8'){
														$scale_custom_format = array(
															0 =>	"null",
															1 =>	"null",
															2 =>	"item_number",
												...
												for($iBarcodes=0; $iBarcodes<15; $iBarcodes++){
													echo "<div style='display: flex;
																		flex-direction: row;
																		justify-content: center;
																		align-items: center;' >";
													echo form_label( 'Barcode - '. ($iBarcodes < 9 ? '0':'').($iBarcodes + 1).' :', 'scale_format_'.$iBarcodes, array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label '));
													echo form_dropdown(
														'scale_custom_format['.$iBarcodes.']',
														array(
															'null'   => lang('config_not_used'),
															'item_number'  => lang('common_item_number'),
															'price'    => lang("common_unit_price"),
															'weight'    => lang("items_weight"),
														),
														($scale_custom_format ? $scale_custom_format[$iBarcodes] : null), 'class="form-control" id="scale_format_'.$iBarcodes.'"'
													);
													echo "</div>";
												}
											?>
							...
							<div class="panel panel-piluku">
								...
								<div id="price_tiers_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
									<div class="panel-body">
                                      ...
                                      <?php $auto_tier_options = '';
                                      foreach($tiers->result() as $tier_option)
                                      {
                                          $auto_tier_options .= '<option value="'.H($tier_option->id).'">'.H($tier_option->name).'</option>';
                                      }
                                      ?>

                                      <div class="form-group no-padding-right" data-keyword="<?php echo H(lang('config_keyword_price_tiers')) ?>">
                                      <?php echo form_label(lang('config_auto_tier_ranges').':', '',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
                                      <div class="col-md-9 col-sm-9 col-lg-10">
                                      <div class="table-responsive">
                                      <table id="auto_tier_ranges" class="table">
                                      <thead>
                                      <tr>
                                      <th><?php echo lang('config_sort'); ?></th>
                                      <th><?php echo lang('common_price_tier'); ?></th>
                                      <th><?php echo lang('config_auto_tier_min_sales'); ?></th>
                                      <th><?php echo lang('config_auto_tier_max_sales'); ?></th>
                                      <th><?php echo lang('common_delete'); ?></th>
                                      </tr>
                                      </thead>
                                      <tbody>
                                      <?php foreach($auto_tier_ranges->result() as $range) { ?>
                                      <tr>
                                      <td><span class="ui-icon ui-icon-arrowthick-2-n-s"></span></td>
                                      <td><?php echo form_dropdown('auto_tier_ranges['.$range->id.'][tier_id]', $default_tier_dropdown, $range->tier_id, 'class="form-control auto_tier_range" data-index="'.$range->id.'"'); ?></td>
                                      <td><input type="text" data-index="<?php echo $range->id; ?>" class="auto_tier_range form-control" name="auto_tier_ranges[<?php echo $range->id; ?>][min_sales]" value="<?php echo to_currency_no_money($range->min_sales,10); ?>" /></td>
                                      <td><input type="text" data-index="<?php echo $range->id; ?>" class="auto_tier_range form-control" name="auto_tier_ranges[<?php echo $range->id; ?>][max_sales]" value="<?php echo to_currency_no_money($range->max_sales,10); ?>" /></td>
                                      <td><a class="delete_auto_tier_range" href="javascript:void(0);" data-range-id='<?php echo $range->id; ?>'><?php echo lang('common_delete'); ?></a></td>
                                      </tr>
                                      <?php } ?>
                                      </tbody>
                                      </table>
                                      <a href="javascript:void(0);" id="add_auto_tier_range"><?php echo lang('config_add_auto_tier_range'); ?></a>
                                      </div>
                                      </div>
                                      </div>
                                       ...
                                       <?php if(count($default_tier_dropdown) > 1) { ?>
                                       <div class="form-group" data-keyword="<?php echo H(lang('config_keyword_price_tiers')) ?>">
                                       <?php echo form_label(lang('config_default_tier').':', 'default_tier_id',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                                       <div class="col-sm-9 col-md-9 col-lg-10">
                                       <?php echo form_dropdown('default_tier_id', $default_tier_dropdown, $this->config->item('default_tier_id')===NULL ? '' : $this->config->item('default_tier_id'), 'class="form-control" id="default_tier_id"'); ?>
                                       </div>
                                       </div>
                                       <?php } ?>

                                       <div class="form-group" data-keyword="<?php echo H(lang('config_keyword_price_tiers')) ?>">
                                       <?php echo form_label(lang('config_calculate_tier_ranges_for_customers').':', 'calculate_tier_ranges_for_customers',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                                       <div class="col-sm-9 col-md-9 col-lg-10">
                                       <button id="calculate_tier_ranges_for_customers" type="button" class="btn btn-lg btn-warning"> <?php echo lang('config_calculate_tier_ranges_for_customers');?></button>
                                       </div>
                                       </div>
							...
							<div class="panel panel-piluku">
								...
								<div id="items_settings_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
									<div class="panel-body">
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_items')) ?>">	
											<?php echo form_label(lang('config_allow_zero_price_location_price_overrides').':', 'allow_zero_price_location_price_overrides',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'allow_zero_price_location_price_overrides',
												'id'=>'allow_zero_price_location_price_overrides',
												'value'=>'allow_zero_price_location_price_overrides',
												'checked'=>$this->config->item('allow_zero_price_location_price_overrides')));?>
												<label for="allow_zero_price_location_price_overrides"><span></span></label>
											</div>
										</div>
							...
							<div class="panel panel-piluku">
								...
								<div id="store_accounts_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
									<div class="panel-body">
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_store_accounts')) ?>">	
										<?php echo form_label(lang('config_do_not_allow_charge_to_store_account_greater_than_amount_due').':', 'do_not_allow_charge_to_store_account_greater_than_amount_due',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'do_not_allow_charge_to_store_account_greater_than_amount_due',
												'id'=>'do_not_allow_charge_to_store_account_greater_than_amount_due',
												'value'=>'do_not_allow_charge_to_store_account_greater_than_amount_due',
												'checked'=>$this->config->item('do_not_allow_charge_to_store_account_greater_than_amount_due')));?>
												<label for="do_not_allow_charge_to_store_account_greater_than_amount_due"><span></span></label>
											</div>
										</div>

										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_store_accounts')) ?>">	
										<?php echo form_label(lang('config_customer_with_negative_store_account_balances_must_keep_balance_at_or_below_0').':', 'customer_with_negative_store_account_balances_must_keep_balance_at_or_below_0',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
												<?php echo form_checkbox(array(
												'name'=>'customer_with_negative_store_account_balances_must_keep_balance_at_or_below_0',
												'id'=>'customer_with_negative_store_account_balances_must_keep_balance_at_or_below_0',
												'value'=>'customer_with_negative_store_account_balances_must_keep_balance_at_or_below_0',
												'checked'=>$this->config->item('customer_with_negative_store_account_balances_must_keep_balance_at_or_below_0')));?>
												<label for="customer_with_negative_store_account_balances_must_keep_balance_at_or_below_0"><span></span></label>
											</div>
										</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_store_accounts')) ?>">	
											<?php echo form_label(lang('config_do_not_allow_store_payment_more_than_balance').':', 'do_not_allow_store_payment_more_than_balance',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'		=>	'do_not_allow_store_payment_more_than_balance',
												'id'		=>	'do_not_allow_store_payment_more_than_balance',
												'value'		=>	'1',
												'checked'	=>	$this->config->item('do_not_allow_store_payment_more_than_balance')));?>
												<label for="do_not_allow_store_payment_more_than_balance"><span></span></label>
											</div>
										</div>

										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_store_accounts')) ?>">	
											<?php echo form_label(lang('config_require_payment_against_store_account_charge').':', 'require_payment_against_store_account_charge',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'		=>	'require_payment_against_store_account_charge',
												'id'		=>	'require_payment_against_store_account_charge',
												'value'		=>	'1',
												'checked'	=>	$this->config->item('require_payment_against_store_account_charge')));?>
												<label for="require_payment_against_store_account_charge"><span></span></label>
											</div>
										</div>
					...
					<div class="row">
						<div class="col-md-12 disable_modules">
							<div class="panel panel-piluku">
                                ...
                                <!-- Rename Modules -->
                                <div class="tab-pane fade" id="rename_modules">
                                        <div class="row">
                                                <div class="col-md-12 rename_modules">
                                                        <div class="panel panel-piluku">
                                                                <div class="panel-heading">
                                                                        <a data-toggle="collapse" data-parent="#collapsePanels" href="#rename_modules_collapse">
                                                                        <?php echo create_section(lang("config_rename_left_menu")) ?>
                                                                        </a>
                                                                </div>
                                                                <div id="rename_modules_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                                                        <div class="panel-body">
                                                                                <?php $module_menu_overrides = isset($module_menu_overrides) ? $module_menu_overrides : array(); ?>
                                                                                <?php foreach ($all_modules->result() as $module) { if($module->module_id=='config') { continue; } ?>
                                                                                        <div class="form-group" data-keyword="<?php echo H(lang($module->name_lang_key)); ?>">
                                                                                                <?php echo form_label(lang($module->name_lang_key).':', 'rename_'.$module->module_id, array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                                                                                                <div class="col-sm-9 col-md-9 col-lg-10">
                        <?php echo form_input(array(
                                'class' => 'form-control form-inps',
                                'name' => 'module_menu_overrides['.$module->module_id.']',
                                'id' => 'rename_'.$module->module_id,
                                'placeholder' => lang($module->name_lang_key),
                                'value' => isset($module_menu_overrides[$module->module_id]) && $module_menu_overrides[$module->module_id] ? $module_menu_overrides[$module->module_id] : ''
                        ));?>
                                                                                                </div>
                                                                                        </div>
                                                                                <?php } ?>
							...
							<div class="panel panel-piluku">
								...
								<div id="application_settings_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
									<div class="panel-body">
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_application_settings')) ?>">	
										<?php echo form_label(lang('config_do_not_format_phone_number').':', 'do_not_format_phone_number',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'do_not_format_phone_number',
												'id'=>'do_not_format_phone_number',
												'value'=>'1',
												'checked'=>$this->config->item('do_not_format_phone_number')));?>
												<label for="do_not_format_phone_number"><span></span></label>
										</div>
									</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_application_settings')) ?>">	
											<?php echo form_label(lang('config_hide_zendesk_chat').':', 'hide_zendesk_chat',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'hide_zendesk_chat',
												'id'=>'hide_zendesk_chat',
												'value'=>'hide_zendesk_chat',
												'checked'=>$this->config->item('hide_zendesk_chat')));?>
												<label for="hide_zendesk_chat"><span></span></label>
											</div>
										</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_application_settings')) ?>">	
											...
											$offline_mode_checkbox = array(
												'name'=>'offline_mode',
												'id'=>'offline_mode',
												'value'=>'offline_mode',
												'checked'=>$this->config->item('offline_mode'));
																								
											echo form_checkbox($offline_mode_checkbox);?>
										...
										<?php if (!is_on_demo_host()) { ?>
											...
											<?php echo form_label(lang('common_test_mode').' ('.lang('config_test_mode_help').'):', 'test_mode',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
												...
												<?php echo form_checkbox(array(
													...
													'id'=>'test_mode',
													'value'=>'test_mode',
													'checked'=>$this->session->userdata('test_mode')));?>
...
<label for="overwrite_existing_items_on_excel_import"><span></span></label>
                                       ...
                                       <div class="form-group" data-keyword="<?php echo H(lang('config_keyword_application_settings')) ?>">
                                       <?php echo form_label(lang('config_do_not_preserve_sale_id_when_importing_sales').':', 'do_not_preserve_sale_id_when_importing_sales',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
                                       <div class="col-sm-9 col-md-9 col-lg-10">
                                       <?php echo form_checkbox(array(
                                       'name'=>'do_not_preserve_sale_id_when_importing_sales',
                                       'id'=>'do_not_preserve_sale_id_when_importing_sales',
                                       'value'=>'1',
                                       'checked'=>$this->config->item('do_not_preserve_sale_id_when_importing_sales')));?>
                                       <label for="do_not_preserve_sale_id_when_importing_sales"><span></span></label>
                                       </div>
                                       </div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_application_settings')) ?>">	
											<?php echo form_label(lang('config_always_enable_location_selling_price_during_receiving').':', 'always_enable_location_selling_price_during_receiving',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'=>'always_enable_location_selling_price_during_receiving',
												'id'=>'always_enable_location_selling_price_during_receiving',
												'value'=>'1',
												'checked'=>$this->config->item('always_enable_location_selling_price_during_receiving')));?>
												<label for="always_enable_location_selling_price_during_receiving"><span></span></label>
											</div>
										</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_email')) ?>">	
											<?php echo form_label(lang('config_sms_mobile_tel_username').':', 'sms_mobile_tel_username',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
												<?php echo form_input(array(
												'class'=>'form-control form-inps',
												'name'=>'sms_mobile_tel_username',
												'id'=>'sms_mobile_tel_username',
												'value'=>$this->config->item('sms_mobile_tel_username')));?>
											</div>
										</div>
										
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_email')) ?>">	
											<?php echo form_label(lang('config_sms_mobile_tel_password').':', 'sms_mobile_tel_password',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
												<?php echo form_input(array(
												'class'=>'form-control form-inps',
												'name'=>'sms_mobile_tel_password',
												'id'=>'sms_mobile_tel_password',
												'value'=>$this->config->item('sms_mobile_tel_password')));?>
											</div>
										</div>

										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_email')) ?>">	
											<?php echo form_label(lang('config_sms_mobile_tel_alias').':', 'sms_mobile_tel_alias',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
												<?php echo form_input(array(
												'class'=>'form-control form-inps',
												'name'=>'sms_mobile_tel_alias',
												'id'=>'sms_mobile_tel_alias',
												'value'=>$this->config->item('sms_mobile_tel_alias')));?>
											</div>
										</div>										
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_disable_appointment_emails')) ?>">	
											<?php echo form_label(lang('config_disable_appointment_emails').':', 'disable_appointment_emails',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_checkbox(array(
												'name'		=>	'disable_appointment_emails',
												'id'		=>	'disable_appointment_emails',
												'value'		=>	'1',
												'checked'	=>	$this->config->item('disable_appointment_emails')));?>
												<label for="disable_appointment_emails"><span></span></label>
											</div>
										</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_application_settings')) ?>">	
											<?php echo form_label(lang('config_advanced_sales_interface').':', 'advanced_sales_interface',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
												<?php echo form_checkbox(array(
												'name'=>'advanced_sales_interface',
												'id'=>'advanced_sales_interface',
												'value'=>'1',
												'checked'=>$this->config->item('advanced_sales_interface')));?>
												<label for="advanced_sales_interface"><span></span></label>
											</div>
										</div>
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_application_settings')) ?>">	
											<?php echo form_label(lang('config_advanced_receiving_interface').':', 'advanced_receiving_interface',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
												<?php echo form_checkbox(array(
												'name'=>'advanced_receiving_interface',
												'id'=>'advanced_receiving_interface',
												'value'=>'1',
												'checked'=>$this->config->item('advanced_receiving_interface')));?>
												<label for="advanced_receiving_interface"><span></span></label>
											</div>
										</div>
									</div>	
								</div>
							...
							<div class="panel panel-piluku">
								...
								<div id="qb_settings_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
									<div class="panel-body">
										...
										<p style="font-size:130%;"><?php echo lang('config_shogo_desc');?></p>
										
										<br />										
										<br />										
										<p class="text-right"><a href="https://shogo.io/pos_partners/php/" class="btn btn-primary" target="_blank"><?php echo lang('common_learn_more'); ?></a></p>
										<br />
										<br />
							...
							<div class="panel panel-piluku">
								...
								<div id="work_order_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
									<div class="panel-body">
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_receipt')) ?>">	
										<?php echo form_label(lang('common_work_order_terms').':', 'work_order_terms',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
											<?php echo form_textarea(array(
												'name'=>'work_order_terms',
												'id'=>'work_order_terms',
												'class'=>'form-control text-area',
												'rows'=>'4',
												'cols'=>'30',
												'value'=>$this->config->item('work_order_terms')));?>
											</div>
										</div>
...
<div class="form-group" data-keyword="<?php echo H(lang('config_show_item_description_on_work_order_sheet')) ?>">
<?php echo form_label(lang('config_show_item_description_on_work_order_sheet').':', 'show_item_description_on_work_order_sheet',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
<div class="col-sm-9 col-md-9 col-lg-10">
<?php echo form_checkbox(array(
'name'=>'show_item_description_on_work_order_sheet',
'id'=>'show_item_description_on_work_order_sheet',
'value'=>'show_item_description_on_work_order_sheet',
'checked'=>$this->config->item('show_item_description_on_work_order_sheet')));?>
<label for="show_item_description_on_work_order_sheet"><span></span></label>
</div>
</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_hide_parts_and_labor_items_on_receipt')) ?>">
											<?php echo form_label(lang('config_hide_parts_and_labor_items_on_receipt').':', 'hide_parts_and_labor_items_on_receipt',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
												<?php echo form_checkbox(array(
													'name'=>'hide_parts_and_labor_items_on_receipt',
													'id'=>'hide_parts_and_labor_items_on_receipt',
													'value'=>'hide_parts_and_labor_items_on_receipt',
													'checked'=>$this->config->item('hide_parts_and_labor_items_on_receipt')));?>
												<label for="hide_parts_and_labor_items_on_receipt"><span></span></label>
											</div>
										</div>
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_work_order_all_warranty_repairs_are_free')) ?>">
											<?php echo form_label(lang('config_work_order_all_warranty_repairs_are_free').':', 'work_order_all_warranty_repairs_are_free',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
												<!-- Dropdown work_order_status -->
												<?php echo form_checkbox(array(
													'name' 		=> 'work_order_all_warranty_repairs_are_free',
													'id' 		=> 'work_order_all_warranty_repairs_are_free',
													'value' 	=> '1',
													'checked' 	=> $this->config->item('work_order_all_warranty_repairs_are_free'))); ?>
												<label for="work_order_all_warranty_repairs_are_free"><span></span></label>
											</div>
										</div>

										<div class="form-group" data-keyword="<?php echo H(lang('config_take_inventory_out_of_system_when_creating_updating_work_order')) ?>">
											<?php echo form_label(lang('config_take_inventory_out_of_system_when_creating_updating_work_order').':', 'take_inventory_out_of_system_when_creating_updating_work_order',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
											<div class="col-sm-9 col-md-9 col-lg-10">
												<!-- Dropdown work_order_status -->
												<?php echo form_checkbox(array(
													'name' 		=> 'take_inventory_out_of_system_when_creating_updating_work_order',
													'id' 		=> 'take_inventory_out_of_system_when_creating_updating_work_order',
													'value' 	=> '1',
													'checked' 	=> $this->config->item('take_inventory_out_of_system_when_creating_updating_work_order'))); ?>
												<label for="take_inventory_out_of_system_when_creating_updating_work_order"><span></span></label>
											</div>
										</div>
...
{	
	...
	$("#price_tiers tbody").sortable();
       ...
       $("#add_tier").click(function(e)
       {
               e.preventDefault();
               e.stopPropagation();
			   $("table#price_tiers tbody").append('<tr><td><span class="ui-icon ui-icon-arrowthick-2-n-s"></span></td><td><input type="text" class="tiers_to_edit form-control" data-index="'+add_index+'" name="tiers_to_edit['+add_index+'][name]" value="" /></td><td><input type="text" class="tiers_to_edit form-control default_percent_off" data-index="'+add_index+'" name="tiers_to_edit['+add_index+'][default_percent_off]" value=""/></td><td><input type="text" class="tiers_to_edit form-control default_cost_plus_percent" data-index="'+add_index+'" name="tiers_to_edit['+add_index+'][default_cost_plus_percent]" value=""/></td><td><input type="text" class="tiers_to_edit form-control default_cost_plus_fixed_amount" data-index="'+add_index+'" name="tiers_to_edit['+add_index+'][default_cost_plus_fixed_amount]" value=""/></td><td>&nbsp;</td></tr>');
              
               add_index--;
               return false;
       });

        $("#auto_tier_ranges tbody").sortable();

        var auto_tier_index = -1;

       $("#add_auto_tier_range").click(function(e)
       {
               e.preventDefault();
               e.stopPropagation();
               var options = <?php echo json_encode($auto_tier_options); ?>;
               $("#auto_tier_ranges tbody").append('<tr><td><span class="ui-icon ui-icon-arrowthick-2-n-s"></span></td><td><select class="form-control auto_tier_range" name="auto_tier_ranges['+auto_tier_index+'][tier_id]">'+options+'</select></td><td><input type="text" class="auto_tier_range form-control" name="auto_tier_ranges['+auto_tier_index+'][min_sales]" value="" /></td><td><input type="text" class="auto_tier_range form-control" name="auto_tier_ranges['+auto_tier_index+'][max_sales]" value="" /></td><td>&nbsp;</td></tr>');
               auto_tier_index--;
               return false;
       });

        $(document).on('click', '.delete_auto_tier_range', function()
        {
                $("#config_form").append('<input type="hidden" name="auto_tier_ranges_to_delete[]" value="'+$(this).data('range-id')+'" />');
                $(this).parent().parent().remove();
        });
...
$("#reset_ecommerce").click(function(event)
{
       ...
       $("#calculate_tier_ranges_for_customers").click(function(event)
       {
               bootbox.confirm(<?php echo json_encode(lang('config_confirm_calculate_tier_ranges')); ?>, function(response)
               {
                       if (response)
                       {
                               $.getJSON(<?php echo json_encode(site_url('config/calculate_customer_tiers')); ?>,function(response)
                               {
                                       if (response.success)
                                       {
                                               show_feedback('success',response.message,<?php echo json_encode(lang('common_success')); ?>);
...
$(function () {
	...
	$("[id^='scale_format_']").on('change', function() {
		$("#scale_format").val('scale_0').change();
	})

	function scale_format_change () {
	let current_value = $("#scale_format").val();
	if (current_value == 'scale_1') {
		$('#scale_format_0').val('null');
		$('#scale_format_1').val('item_number');
		$('#scale_format_2').val('item_number');
		$('#scale_format_3').val('item_number');
		$('#scale_format_4').val('item_number');
		$('#scale_format_5').val('item_number');
		$('#scale_format_6').val('null');
		$('#scale_format_7').val('price');
		$('#scale_format_8').val('price');
		$('#scale_format_9').val('price');
		$('#scale_format_10').val('price');
		$('#scale_format_11').val('null');
		$('#scale_format_12').val('null');
		$('#scale_format_13').val('null');
		$('#scale_format_14').val('null');
	} else if (current_value == 'scale_2') {
		$('#scale_format_0').val('null');
		$('#scale_format_1').val('item_number');
		$('#scale_format_2').val('item_number');
		$('#scale_format_3').val('item_number');
		...
		$('#scale_format_9').val('price');
		$('#scale_format_10').val('price');
		$('#scale_format_11').val('price');
		$('#scale_format_12').val('null');
		$('#scale_format_13').val('null');
		$('#scale_format_14').val('null');
	} else if (current_value == 'scale_4') {
		$('#scale_format_0').val('null');
		$('#scale_format_1').val('item_number');
		$('#scale_format_2').val('item_number');
		$('#scale_format_3').val('item_number');
		...
		$('#scale_format_4').val('item_number');
		$('#scale_format_5').val('item_number');
		$('#scale_format_6').val('weight');
		$('#scale_format_7').val('weight');
		$('#scale_format_8').val('weight');
		$('#scale_format_9').val('weight');
		$('#scale_format_10').val('weight');
		$('#scale_format_11').val('weight');
		$('#scale_format_12').val('null');
		$('#scale_format_13').val('null');
		$('#scale_format_14').val('null');
	} else if (current_value == 'scale_6') {
		$('#scale_format_0').val('null');
		$('#scale_format_1').val('null');
		$('#scale_format_2').val('item_number');
		$('#scale_format_3').val('item_number');
		$('#scale_format_4').val('item_number');
		$('#scale_format_5').val('item_number');
		$('#scale_format_6').val('item_number');
		$('#scale_format_7').val('weight');
		$('#scale_format_8').val('weight');
		$('#scale_format_9').val('weight');
		$('#scale_format_10').val('weight');
		...
		$('#scale_format_5').val('item_number');
		$('#scale_format_6').val('item_number');
		$('#scale_format_7').val('item_number');
		$('#scale_format_8').val('weight');
		$('#scale_format_9').val('weight');
		$('#scale_format_10').val('weight');
		$('#scale_format_11').val('weight');
...
$("#scale_format").on("change", scale_format_change);
scale_format_change();
