			...
			<div class="panel-body">
				<div class="row form-group">
					<div class="col-xs-12">
						...
						<?php echo form_open($controller_name . '/' . ( isset($action) ? $action : "save_custom_fields" ), array('id' => 'save_custom_fields', 'class' => 'form-horizontal')); ?>
...
<div class="form-group">
<?php echo form_label(lang('common_show_on_customer_intake_form') . ':', 'show_on_customer_intake_form', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label wide')); ?>
<div class="col-sm-9 col-md-9 col-lg-10">
<?php echo form_checkbox(array(
'name' => "custom_field_${k}_show_on_customer_intake_form",
'id' => "custom_field_${k}_show_on_customer_intake_form",
'class' => 'delete-checkbox',
'value' => 1,
'checked' => isset(${"custom_field_${k}_show_on_customer_intake_form"}) ? ${"custom_field_${k}_show_on_customer_intake_form"} : ''
)); ?>
<label for="custom_field_<?php echo $k; ?>_show_on_customer_intake_form"><span></span></label>
</div>
</div>
<?php } ?>
