...
<div class="modal-dialog customer-recent-sales">
	<div class="modal-content">
		<div class="modal-header">
			...
			<?php
                               $report_link = site_url('reports/generate/specific_customer?report_type=simple&report_date_range_simple=ALL_TIME&customer_id='.$customer_id.'&sale_type=all&export_excel=0')
				?>
				<a class="btn btn-primary" href="<?php echo $report_link; ?>"
					style="margin-top: -35px;
					margin-right: 32px;
					font-size: medium;
					float: right;"><?php echo lang('reports_detailed_customers_report'); ?></a>
		</div>
		<div class="modal-body nopadding">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#info"><?php echo lang('customers_basic_information'); ?></a></li>
				<li><a data-toggle="tab" href="#completed"><?php echo lang('sales_completed_sales'); ?></a></li>
				...
				<div id="info" class="tab-pane fade in active">
					...
					<table class="table table-bordered table-hover table-striped" style="width: 80%;margin:10px auto;padding:20px;">
						<?php
 						...
 						<tr><td width="40%"><?php echo lang('common_phone_numbers')?></td> <td><?php echo $customer_phone_numbers;?></td></tr>
