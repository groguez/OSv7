		...
		<div class="panel panel-piluku">
			<div class="panel-body panel-pad">
			    <div class="row">
			        ...
			        <div class="col-md-4 col-sm-4 col-xs-12">
			            <ul class="list-unstyled invoice-address">
							...
							<?php } ?>
							<li class="title">
								<span class="pull-left"> <?php echo $this->config->item('override_fulfillment_sheet_title') !== '' ? $this->config->item('override_fulfillment_sheet_title') : lang('sales_fulfillment_sheet'); ?></span>
			        ...
			        <div class="col-md-4 col-sm-4 col-xs-12">
			            <ul class="list-unstyled invoice-detail">
							<li>
								 <?php echo $this->config->item('override_fulfillment_sheet_title') !== '' ? $this->config->item('override_fulfillment_sheet_title') : lang('sales_fulfillment_sheet'); ?>
								 <br>
			    ...
			    <div class="invoice-table-content">
					...
					<?php if($discount_exists) { ?>
					<div class="col-md-2 col-sm-2 col-xs-<?php echo $xs_col; ?>">
					    <div class="invoice-content"><?php echo $item['flat_discount_amount'] > 0 ? to_currency($item['flat_discount_amount']) . " ( ". lang('common_flat_discount') . ")" : to_quantity($item['discount_percent']); ?></div>
					</div>
					<?php } ?>
					...
					<div class="col-md-2 col-sm-2 col-xs-<?php echo $xs_col; ?>">
		                ...
		                <div class="invoice-content pull-right"><?php echo $item['flat_discount_amount'] > 0 ? to_currency(($item['item_unit_price']-$item['flat_discount_amount'])*$item['quantity_purchased']) : to_currency($item['item_unit_price']*$item['quantity_purchased']-$item['item_unit_price']*$item['quantity_purchased']*$item['discount_percent']/100); ?></div>
			        </div>
						<?php } ?>				
					</div>
			    </div>
			...
			?>
				...
				foreach ($sale_custom_fields_to_display as $custom_field_id) {
					if ($this->Sale->get_custom_field($custom_field_id) !== false) {
