...
<script type="text/javascript">
	<?php if ($this->session->flashdata('unsuspend_failed_message')) { ?>
		show_feedback('error', <?php echo json_encode($this->session->flashdata('unsuspend_failed_message')); ?>, <?php echo json_encode(lang('common_error')); ?>);
	<?php } ?>
	...
	function attachEvents()
	{
		...
		$(".form_email_receipt_suspended_sale").ajaxForm({success: function(result)
		{
