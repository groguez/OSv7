					...
					<div class="col-md-6">
						...
						<div class="col-md-12 form">
							<?php foreach(unserialize($this->config->item('track_payment_types')) as $payment_type_track) { 
		   					 ...
		   					 $payment_type_track_key = str_replace(' ', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', $payment_type_track);	
							?>
							...
							<?php } ?>
										 ...
										 <?php } ?>
											...
											<?php echo form_input(array(
											'name'=>'closing_amount['.$payment_type_track_key.']',
												'class'=>'form-control closing_amount',
												'id'=> 'closing_amount_'.$payment_type_track_key,
