...
<?php echo form_label(lang('locations_disable_markup_markdown').':', 'disable_markup_markdown',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                               ...
                               <div class="form-group">
                               <?php echo form_label(lang('locations_do_not_allow_below_cost').':', 'do_not_allow_below_cost',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                                       <div class="col-sm-9 col-md-9 col-lg-10">
                                       <?php echo form_dropdown('do_not_allow_below_cost',array('' => lang('common_do_not_override'),'1' => lang('common_yes'),'0' => lang('common_no')),(string)($location_info->do_not_allow_below_cost !== '' && $location_info->do_not_allow_below_cost !== NULL ? $location_info->do_not_allow_below_cost : ''), 'class="form-control" id="do_not_allow_below_cost"'); ?>
                                       </div>
                               </div>

                               <div class="form-group">
                               <?php echo form_label(lang('locations_do_not_allow_out_of_stock_items_to_be_sold').':', 'do_not_allow_out_of_stock_items_to_be_sold',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                                       <div class="col-sm-9 col-md-9 col-lg-10">
                                       <?php echo form_dropdown('do_not_allow_out_of_stock_items_to_be_sold',array('' => lang('common_do_not_override'),'1' => lang('common_yes'),'0' => lang('common_no')),(string)($location_info->do_not_allow_out_of_stock_items_to_be_sold !== '' && $location_info->do_not_allow_out_of_stock_items_to_be_sold !== NULL ? $location_info->do_not_allow_out_of_stock_items_to_be_sold : ''),'class="form-control" id="do_not_allow_out_of_stock_items_to_be_sold"'); ?>
                                       </div>
                               </div>

                               <div class="form-group">
                               <?php echo form_label(lang('locations_do_not_allow_items_to_go_out_of_stock_when_transfering').':', 'do_not_allow_items_to_go_out_of_stock_when_transfering',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                                       <div class="col-sm-9 col-md-9 col-lg-10">
                                       <?php echo form_dropdown('do_not_allow_items_to_go_out_of_stock_when_transfering',array('' => lang('common_do_not_override'),'1' => lang('common_yes'),'0' => lang('common_no')),(string)($location_info->do_not_allow_items_to_go_out_of_stock_when_transfering !== '' && $location_info->do_not_allow_items_to_go_out_of_stock_when_transfering !== NULL ? $location_info->do_not_allow_items_to_go_out_of_stock_when_transfering : ''),'class="form-control" id="do_not_allow_items_to_go_out_of_stock_when_transfering"'); ?>
                                       </div>
                               </div>
								...
								<?php if (count($this->Appconfig->get_exchange_rates()->result_array())) { ?>
								<div class="form-group">	
									<?php echo form_label(lang('locations_currency_default_exchange_rate').':', 'locations_currency_default_exchange_rate',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
									<div class="col-sm-9 col-md-9 col-lg-10">
										<?php echo form_dropdown('currency_rate_id', $exchange_currency_rates, $location_info->currency_rate_id, 'class="form-control" id="currency_rate_id"');?>
									</div>
								</div>
								<?php } ?>
									...
									<div class="table-responsive m-lr-15">
										<table id="price_registers" class="table">
											<thead>
												...
												<th class="emv_terminal_id register-cc-field non_valor_fields"><?php echo lang('locations_terminal_id'); ?></th>
												<th class="emv_terminal_id valor_fields">Valor EPI</th>
												<th class="valor_appkey valor_fields"><?php echo lang('common_valor_app_id'); ?></th>
												<th class="enable_tips register-cc-field"><?php echo lang('config_enable_tips'); ?></th>
												<th class="register-cc-field register-cc-field-datacap"><?php echo lang('locations_secure_device_override_emv'); ?></th>
												<th class="register-cc-field register-cc-field-datacap"><?php echo lang('locations_secure_device_override_non_emv'); ?></th>
											...
											foreach($registers->result() as $register) { ?>
												<tr><td><span class="dot terminal"></span><input type="text" class="form-control next-to-status" name="registers_to_edit[<?php echo $register->register_id; ?>][name]" value="<?php echo H($register->name); ?>" /></td>
														...
														?>
															...
															<script>
															    $("#square_terminal_get_id_<?php echo $register->register_id; ?>").click(function() {
															        ...
															        // First call to get the device code
															        $.getJSON(<?php echo json_encode(site_url('locations/square_terminal_get_id/'.$location_info->location_id.'/'.$register->register_id)); ?>, function(response) {

															            // Show the device code and a continue button
															            bootbox.dialog({
															                title: <?php echo json_encode(lang('config_device_id')); ?>,
															                message: response.code + "<br><br><button id='continue_btn' class='btn btn-primary'><?php echo lang('locations_entered_device_code'); ?></button>"
															            });

															            // Handle the continue button click
															            $("#continue_btn").click(function() {
																            bootbox.hideAll(); // Hide the loading indicator
																			
															                // Show loading indicator again for the second call
															                bootbox.dialog({
															                    title: <?php echo json_encode(lang('common_processing').'...'); ?>,
															                    message: "<div class='text-center'><i class='fa fa-spinner fa-spin'></i>"+<?php echo json_encode(lang('common_verifying').'...'); ?>+"</div>",
															                    closeButton: false
															                });

															                // Second call to set the device ID
															                $.getJSON(<?php echo json_encode(site_url('locations/square_get_and_set_device_id')); ?> + "/" + response.id + "/" + <?php echo json_encode($location_info->location_id); ?> + "/" + <?php echo json_encode($register->register_id); ?>, function(finalResponse) {
																	            bootbox.hideAll(); // Hide the loading indicator
																				...
																				{
															                        bootbox.alert(<?php echo json_encode(lang('common_error')); ?>);
															                    }
															                });
															            });
															        });
													...
													<td class="valor_fields"><input id="valor_appkey<?php echo $counter;?>" type="text" class="form-control valor_appkey valor_fields" name="registers_to_edit[<?php echo $register->register_id; ?>][valor_appkey]" value="<?php echo H($register->valor_appkey); ?>" /></td>											
													...
													<td><input type="text" class="form-control register-cc-field register-cc-field-datacap" name="registers_to_edit[<?php echo $register->register_id; ?>][secure_device_emv]" value="<?php echo H($register->secure_device_emv); ?>" /></td>
													<td><input type="text" class="form-control register-cc-field register-cc-field-datacap" name="registers_to_edit[<?php echo $register->register_id; ?>][secure_device_non_emv]" value="<?php echo H($register->secure_device_non_emv); ?>" /></td>
							...
							<div class="panel-body">
								...
								<div id="merchant_information">
									...
									<div class="form-group">	
										...
										{
											echo form_dropdown('credit_card_processor', array('coreclear2' =>$this->config->item('branding')['short_name'].' Payments Premium','square_terminal' => 'Square Terminal','square' => 'Square iOS'), $location_info->credit_card_processor, 'class="form-control" id="credit_card_processor"');
										}
										?>
									...
									<div id="square_info">						
										<div class="form-group square_terminal_info">	
										...
										<div class="form-group square_info">	
								...
								<div id="valor_info">	
									...
									<div class="form-group">	
										<?php echo form_label(lang('common_valor_merchant_id').':', 'valor_appid',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
										<div class="col-sm-9 col-md-9 col-lg-10">
										<?php echo form_input(array(
											'class'=>'form-control form-inps',
											'name'=>'valor_appid',
											'id'=>'valor_appid',
											'autocomplete'=>'off',
											'value'=>$location_info->valor_appid));?>
										</div>
									...
									<div class="form-group">	
										<?php echo form_label(lang('common_valor_override_channel_id').':', 'valor_channel_override',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
										<div class="col-sm-9 col-md-9 col-lg-10">
										<?php echo form_input(array(
											'class'=>'form-control form-inps',
											'name'=>'valor_channel_override',
											'id'=>'valor_channel_override',
											'autocomplete'=>'off',
											'value'=>$location_info->valor_channel_override));?>
										</div>
...
<script type='text/javascript'>
	...
	var add_register_index = 0;
      ...
      $('#color').colorpicker();
			...
			{
				$("#price_registers tbody").append('<tr><td><span class="dot terminal"></span><input type="text" class="registers_to_add form-control next-to-status" name="registers_to_add['+add_register_index+'][name]" value="" /></td><td class="valor_fields"><input type="text" class="registers_to_add form-control valor_fields" name="registers_to_add['+add_register_index+'][valor_appkey]" value="" /></td><td class="card_connect_info"><input type="text" class="registers_to_add form-control register-cc-field" name="registers_to_add['+add_register_index+'][card_connect_hsn]" value="" /></td><td><input type="text" class="registers_to_add form-control register-cc-field" name="registers_to_add['+add_register_index+'][emv_terminal_id]" value="" /></td><td class="enable_tips register-cc-field"><input type="checkbox" name="registers_to_add['+add_register_index+'][enable_tips]" value="1" id="registers_to_add_'+add_register_index+'_enable_tips"><label for="registers_to_add_'+add_register_index+'_enable_tips"><span></span></label></td><td><input type="text" class="form-control register-cc-field register-cc-field-datacap" name="registers_to_add['+add_register_index+'][secure_device_emv]" value="" /></td><td><input type="text" class="form-control register-cc-field register-cc-field-datacap" name="registers_to_add['+add_register_index+'][secure_device_non_emv]" value="" /></td><td><input type="text" class="registers_to_add form-control iptran register-cc-field register-cc-field-datacap" name="registers_to_add['+add_register_index+'][iptran_device_id]" value="" /></td><td><input type="text" class="registers_to_add form-control iptran register-cc-field register-cc-field-datacap" name="registers_to_add['+add_register_index+'][emv_pinpad_ip]" value="" /></td><td><input type="text" class="registers_to_add form-control iptran register-cc-field register-cc-field-datacap" name="registers_to_add['+add_register_index+'][emv_pinpad_port]" value="" /></td><td><a class="update_parameters_ip_tran register-cc-field register-cc-field-datacap" href="javascript:void(0);"><?php echo lang('locations_update_params_ip_tran'); ?></a><span class="register-cc-field register-cc-field-datacap"> / </span><a class="init_ip_tran register-cc-field register-cc-field-datacap" href="javascript:void(0);"><?php echo lang('locations_init_mercury_emv'); ?></a> </td><td>&nbsp;</td></tr>');
