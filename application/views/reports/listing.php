			...
			<div class="panel-body">
				<div class="list-group parent-list">
					<a href="#" class="list-group-item" id="saved"><i class="icon ti-heart" style="color: #fb5d5d"></i>	<?php echo lang('reports_saved_reports'); ?></a>
                                        <a href="#" class="list-group-item" id="popular"><i class="icon ti-star"></i>     <?php echo lang('reports_popular_reports'); ?></a>
		...
		<div class="panel">
			...
			<h3 id="right_heading" class="page-header text-info"><i class="icon ti-angle-double-left"></i><?php echo lang('reports_make_a_selection')?></h3>
				...
				<?php	} ?>
                               ...
                               <div class="list-group popular hidden">
                                       <a class="list-group-item" href="<?php echo site_url('reports/generate/summary_items');?>" ><i class="icon ti-receipt"></i> <?php echo lang('reports_summary_items'); ?></a>
                                       <a class="list-group-item" href="<?php echo site_url('reports/generate/detailed_sales');?>" ><i class="icon ti-calendar"></i> <?php echo lang('reports_detailed_sales_report'); ?></a>
                                       <a class="list-group-item" href="<?php echo site_url('reports/generate/closeout');?>" ><i class="icon ti-receipt"></i> <?php echo lang('reports_closeout'); ?></a>
                                       <a class="list-group-item" href="<?php echo site_url('reports/generate/detailed_profit_and_loss');?>" ><i class="icon ti-calendar"></i> <?php echo lang('reports_detailed_profit_and_loss'); ?></a>
                                       <a class="list-group-item" href="<?php echo site_url('reports/generate/summary_customers');?>" ><i class="icon ti-receipt"></i> <?php echo lang('reports_customers_summary_report'); ?></a>
                                       <a class="list-group-item" href="<?php echo site_url('reports/generate/summary_expenses');?>" ><i class="icon ti-receipt"></i> <?php echo lang('reports_expenses_summary_report'); ?></a>
                                       <a class="list-group-item" href="<?php echo site_url('reports/generate/detailed_receivings');?>" ><i class="icon ti-calendar"></i> <?php echo lang('reports_detailed_receivings_report'); ?></a>
                                </div>
				<div class="list-group customers hidden">
					...
					<a class="list-group-item" href="<?php echo site_url('reports/generate/detailed_new_customers');?>" ><i class="icon ti-calendar"></i> <?php echo lang('reports_detailed_new_customers'); ?></a>
				...
				<div class="list-group items hidden">
					...
					<a href="<?php echo site_url('reports/generate/best_selling_attribute');?>" class="list-group-item"><i class="icon ti-receipt"></i> <?php echo lang('reports_items_best_selling_attribute'); ?></a>
				...
				<div class="list-group taxes hidden">
					...
					<a href="<?php echo site_url('reports/generate/tax_by_payments_received');?>" class="list-group-item"><i class="icon ti-calendar"></i> <?php echo lang('reports_tax_by_payments_received'); ?></a>
				...
				<div class="list-group inventory hidden">
					...
					<a href="<?php echo site_url('reports/generate/inventory_aging');?>" class="list-group-item"><i class="icon ti-receipt"></i> <?php echo lang('reports_aging_reports'); ?></a>
				</div>
				...
				<div class="list-group store-accounts hidden">
					...
					<?php if ($this->config->item('customers_store_accounts') && $this->Employee->has_module_action_permission('reports', 'view_store_account', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>					
						...
						<a href="<?php echo site_url('reports/generate/store_account_payments');?>" class="list-group-item"><i class="icon ti-calendar"></i> <?php echo lang('reports_store_account_payments_report'); ?></a>
					<?php } ?>
					<br>
				...
				<div class="list-group closeout hidden">
					...
					<?php if ($cc_processor_class_name == 'VALORPROCESSOR' && $this->Employee->has_module_action_permission('sales', 'view_edit_transaction_history', $this->Employee->get_logged_in_employee_info()->person_id)) {?>				
