	...
	<div class="col-md-12">
		<div class="panel panel-piluku">
			<div class="panel-heading">
				...
				<?php echo $subtitle ?>
				<?php if(isset($selected_report_locations)){?>
					<br /><small class="reports-range"><?php echo lang('common_locations').': '.implode(', ', $selected_report_locations); ?></small>
				<?php } ?>
				<?php if($key) { ?>
			...
			<div class="panel-body">
				<div class="col-md-6">
					...
					<h3><?php echo lang('common_cogs'); ?></h3>
					<div class="table-responsive">
						<table class="table table-bordered table-reports  table-striped table-hover  tablesorter">
							<?php foreach($details_data['sales_by_category'] as $category) { ?>
							<tr>
								<td><?php echo $this->Category->get_full_path($category['category_id']); ?></td>
								<td style="text-align: right;"><?php echo to_currency($category['total'] - $category['profit']); ?></td>
							</tr>
						...
						<h3><?php echo lang('common_payments'); ?></h3>
						<div class="table-responsive">
							<table class="table table-bordered table-reports  table-striped table-hover  tablesorter">
					...
					{
					?>
						<h3><?php echo lang('common_gross_profit'); ?></h3>
						<div class="table-responsive">
							<table class="table table-bordered table-striped table-hover  tablesorter">
								<tr>
									<td><?php echo lang('reports_total'); ?></td>
				...
				<div class="col-md-6">
					...
					?>
						...
						<div class="table-responsive">
						<table style="width: 100%;" class="table table-bordered table-striped table-hover  tablesorter">
							<tr>
								<td><?php echo lang('reports_total'); ?></td>
					...
					<h3><?php echo lang('reports_store_account'); ?> (<?php echo lang('common_as_of').' '.date(get_date_format().' '.get_time_format())?>)</h3>
					<div class="table-responsive">
					<table style="width: 100%;" class="table table-bordered table-striped table-hover  tablesorter">
						<tr>
							<td><?php echo lang('reports_account_receivable'); ?></td>
							<td style="text-align: right;"><?php echo to_currency($details_data['accounts_receivable']); ?></td>
						</tr>
						
						<tr>
							<td><?php echo lang('reports_account_payable'); ?></td>
							<td style="text-align: right;"><?php echo to_currency($details_data['accounts_payable']); ?></td>
						</tr>
						
					</table>
					</div>
					
					<h3><?php echo lang('reports_inventory_total'); ?> (<?php echo lang('common_as_of').' '.date(get_date_format().' '.get_time_format())?>)</h3>
					<div class="table-responsive">
					<table style="width: 100%;" class="table table-bordered table-striped table-hover  tablesorter">
						<tr>
							<td><?php echo lang('reports_inventory_total'); ?></td>
							<td style="text-align: right;"><?php echo to_currency($details_data['total_inventory_value']); ?></td>
						</tr>
