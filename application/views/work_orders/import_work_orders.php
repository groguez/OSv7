				        ...
				        <div class="col-xs-12">
				            <div id="Complete" class="col-md-12 well text-center">
				                ...
				                <p class="text-center">
												...
												<button id="complete_import" class="btn btn-primary" action="<?php echo site_url('work_orders/complete_excel_import_work_order');?>"><?php echo lang('common_complete_excel_import') ?></button>
