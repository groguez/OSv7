...
$lang['gmail_api_token_registered'] = '%BRANDING_NAME% ahora está autorizado para enviar correos electrónicos en nombre de su cuenta de Gmail. Puede cerrar esta ventana.';
...
$lang['config_allow_customers_to_pay_suspended_sales_online'] = 'Permitir a los clientes pagar en línea las ventas suspendidas';

$lang['config_work_order_all_warranty_repairs_are_free'] = 'Todas las reparaciones en garantía son gratuitas';

$lang['config_disable_appointment_emails'] = 'Desactivar correos electrónicos de citas';
$lang['config_allow_zero_price_location_price_overrides'] = 'Permitir anulaciones de precios de ubicación de precio cero';


$lang['config_hide_zendesk_chat'] = 'Ocultar el bot de chat de soporte de IA';
$lang['config_advanced_sales_interface'] = 'Interfaz de ventas avanzada';
$lang['config_advanced_receiving_interface'] = 'Interfaz de recepción avanzada';

$lang['config_do_not_allow_charge_to_store_account_greater_than_amount_due'] = 'No permita que el cargo a la cuenta de la tienda supere el monto adeudado';
$lang['config_customer_with_negative_store_account_balances_must_keep_balance_at_or_below_0'] = 'Los clientes con saldos negativos en las cuentas de la tienda deben mantener el saldo en 0 o menos';

$lang['config_shogo_desc'] = '%BRANDING_NAME% ahora se integra con TODOS los principales programas de contabilidad a través de nuestro socio Shogo. Esto reemplazará nuestra integración actual de Quickbooks en el futuro. Nuestro socio permite una integración más flexible y también incluye compras y mapeo de cuentas personalizado.';
$lang['config_hide_price_rule_on_receipt'] = 'Ocultar nombre de regla de precio en el recibo';
$lang['common_work_order_terms'] = 'Términos y condiciones de la orden de trabajo';
$lang['config_show_email_of_company_on_receipt'] = 'Mostrar el correo electrónico de la empresa al recibirlo';

$lang['config_update_base_unit_price_from_units'] = 'Actualizar precio de venta base desde precio unitario';
$lang['config_take_inventory_out_of_system_when_creating_updating_work_order'] = 'Saque el inventario del sistema al crear/actualizar la orden de trabajo';


$lang['config_sms_mobile_tel_alias'] = 'Alias de teléfono móvil';
$lang['config_sms_mobile_tel_username'] = 'Nombre de usuario del teléfono móvil';
$lang['config_sms_mobile_tel_password'] = 'Contraseña de teléfono móvil';

$lang['config_show_weight_and_dim_on_receipt'] = 'Mostrar peso y dimensiones en el recibo';

$lang['config_do_not_suspended_receipt_created_by_someone_else'] = 'NO permita que el empleado cancele la suspensión de una venta creada por otra persona';

$lang['config_always_enable_location_selling_price_during_receiving'] = 'Habilitar siempre la actualización del precio de venta por ubicación durante la recepción';
$lang['config_inventory_post_date_is_always_sale_date'] = 'La fecha del inventario es siempre la fecha de venta';
$lang['config_not_used'] = 'No utilizado';
$lang['config_price_weight'] = 'Precio / Peso';
$lang['config_scale_0'] = 'Formato personalizado';
$lang['config_override_fulfillment_sheet_title'] = 'Título de la hoja de cumplimiento de anulación';
$lang['config_show_line_item_sales_person_on_receipt'] = 'Mostrar el artículo de línea del vendedor en el recibo';
$lang['config_hide_parts_and_labor_items_on_receipt'] = 'Ocultar piezas y elementos de mano de obra en el recibo';
$lang['config_show_debit_payment_option_when_using_integrated_credit_card_processing'] = 'Mostrar el tipo de pago con tarjeta de débito al realizar el procesamiento integrado de tarjetas de crédito';
$lang['config_shopify_step_size'] = 'Tamaño de paso de Shopify para productos que no son números enteros';
$lang['config_do_not_format_phone_number'] = 'NO formatear el número de teléfono';

$lang['config_hide_name_on_qr_codes'] = 'Ocultar nombre en códigos QR';
$lang['config_hide_price_on_qr_codes'] = 'Ocultar al príncipe en los códigos QR';
$lang['config_qr_code_price_include_tax'] = 'Incluir impuestos en los códigos QR';
$lang['config_do_not_allow_store_payment_more_than_balance'] = 'No permita que el pago en la tienda supere su saldo';
$lang['config_require_payment_against_store_account_charge'] = 'Exigir que el pago se realice contra un cargo de la cuenta de la tienda';
$lang['config_enable_giftcard_security'] = 'Habilitar la seguridad de la tarjeta de regalo';

$lang['config_default_tier'] = 'Nivel predeterminado';
...
$lang['config_do_not_preserve_sale_id_when_importing_sales'] = 'No conservar el ID de venta al importar ventas';


$lang['config_auto_tier_ranges'] = 'Rangos de niveles automáticos';
$lang['config_add_auto_tier_range'] = 'Agregar rango de niveles automático';
$lang['config_auto_tier_min_sales'] = 'Ventas mínimas de por vida';
$lang['config_auto_tier_max_sales'] = 'Ventas máximas de por vida';
$lang['config_enable_auto_tiering'] = 'Habilitar la clasificación automática por niveles';
$lang['config_always_show_expire_date_in_recv'] = 'Mostrar siempre la fecha de caducidad en la recepción';
$lang['config_rename_left_menu'] = 'Cambiar el nombre del menú izquierdo';
$lang['config_show_item_description_on_work_order_sheet'] = 'Mostrar la descripción del artículo en la hoja de orden de trabajo';
?>
