...
$lang['config_smtp_host'] = 'Endereço do servidor SMTP';
...
$lang['config_smtp_timeout'] = 'Tempo limite de SMTP';
...
$lang['config_woo_api_url'] = 'URL da API do Woocommerce';
...
$lang['config_ecom_sync_logs'] = 'Registros de sincronização de comércio eletrônico';
...
$lang['config_api_keys'] = 'Chaves de API';
...
$lang['config_webhooks'] = 'Ganchos da Web';
...
$lang['gmail_api_token_registered'] = 'O %BRANDING_NAME% agora está autorizado a enviar e-mails em nome da sua conta do Gmail. Você pode fechar esta janela.';
...
$lang['config_allow_customers_to_pay_suspended_sales_online'] = 'Permitir que os clientes paguem vendas suspensas online';

$lang['config_work_order_all_warranty_repairs_are_free'] = 'Todos os reparos em garantia são gratuitos';

$lang['config_disable_appointment_emails'] = 'Desativar e-mails de compromisso';
$lang['config_allow_zero_price_location_price_overrides'] = 'Permitir substituições de preço de localização com preço zero';


$lang['config_hide_zendesk_chat'] = 'Ocultar bot de bate-papo de suporte de IA';
$lang['config_advanced_sales_interface'] = 'Interface de vendas avançada';
$lang['config_advanced_receiving_interface'] = 'Interface de recepção avançada';

$lang['config_do_not_allow_charge_to_store_account_greater_than_amount_due'] = 'Não permitir cobrança na conta da loja superior ao valor devido';
$lang['config_customer_with_negative_store_account_balances_must_keep_balance_at_or_below_0'] = 'Os clientes com saldos negativos nas contas da loja devem manter o saldo igual ou inferior a 0';

$lang['config_shogo_desc'] = '%BRANDING_NAME% agora se integra a TODOS os principais softwares de contabilidade por meio de nosso parceiro Shogo. Isso substituirá nossa integração atual de quickbooks no futuro. Nosso parceiro permite uma integração mais flexível e também inclui compras e mapeamento de contas personalizado';
$lang['config_hide_price_rule_on_receipt'] = 'Ocultar o nome da regra de preço no recebimento';
$lang['common_work_order_terms'] = 'Termos e Condições da Ordem de Serviço';
$lang['config_show_email_of_company_on_receipt'] = 'Mostrar e-mail da empresa no recebimento';

$lang['config_update_base_unit_price_from_units'] = 'Atualizar preço base de venda do preço unitário';
$lang['config_take_inventory_out_of_system_when_creating_updating_work_order'] = 'Retire o inventário do sistema ao criar/atualizar ordem de serviço';


$lang['config_sms_mobile_tel_alias'] = 'Alias de telefone móvel';
$lang['config_sms_mobile_tel_username'] = 'Nome de usuário do telefone móvel';
$lang['config_sms_mobile_tel_password'] = 'Senha do telefone móvel';

$lang['config_show_weight_and_dim_on_receipt'] = 'Mostrar peso e dimensões no recibo';

$lang['config_do_not_suspended_receipt_created_by_someone_else'] = 'NÃO permita que o funcionário cancele a suspensão de uma venda criada por outra pessoa';

$lang['config_always_enable_location_selling_price_during_receiving'] = 'Sempre habilitar atualização de preço de venda de localização durante o recebimento';
$lang['config_inventory_post_date_is_always_sale_date'] = 'A data do inventário é sempre a data da venda';
$lang['config_not_used'] = 'Não usado';
$lang['config_price_weight'] = 'Preço / Peso';
$lang['config_scale_0'] = 'Formato personalizado';
$lang['config_override_fulfillment_sheet_title'] = 'Substituir título da folha de atendimento';
$lang['config_show_line_item_sales_person_on_receipt'] = 'Mostrar item de linha do vendedor no recebimento';
$lang['config_hide_parts_and_labor_items_on_receipt'] = 'Ocultar peças e itens de mão de obra no recebimento';
$lang['config_show_debit_payment_option_when_using_integrated_credit_card_processing'] = 'Mostrar tipo de pagamento com cartão de débito ao fazer processamento integrado de cartão de crédito';
$lang['config_shopify_step_size'] = 'Tamanho do passo do Shopify para produtos não inteiros';
$lang['config_do_not_format_phone_number'] = 'NÃO formate o número de telefone';

$lang['config_hide_name_on_qr_codes'] = 'Ocultar nome em códigos QR';
$lang['config_hide_price_on_qr_codes'] = 'Esconder príncipe em códigos QR';
$lang['config_qr_code_price_include_tax'] = 'Incluir imposto em códigos QR';
$lang['config_do_not_allow_store_payment_more_than_balance'] = 'Não permita que o pagamento da loja exceda o seu saldo';
$lang['config_require_payment_against_store_account_charge'] = 'Exigir que o pagamento seja feito contra uma cobrança de conta da loja';
$lang['config_enable_giftcard_security'] = 'Habilitar segurança do vale-presente';

$lang['config_default_tier'] = 'Nível padrão';
...
$lang['config_auto_tier_ranges'] = 'Faixas de níveis automáticos';
$lang['config_add_auto_tier_range'] = 'Adicionar intervalo de nível automático';
$lang['config_auto_tier_min_sales'] = 'Vendas mínimas vitalícias';
$lang['config_auto_tier_max_sales'] = 'Vendas máximas vitalícias';
$lang['config_enable_auto_tiering'] = 'Habilitar autonivelamento';
$lang['config_always_show_expire_date_in_recv'] = 'Sempre mostrar a data de validade no recebimento';
$lang['config_rename_left_menu'] = 'Renomear Menu Esquerdo';
$lang['config_show_item_description_on_work_order_sheet'] = 'Mostrar descrição do item na folha de ordem de serviço';
?>
