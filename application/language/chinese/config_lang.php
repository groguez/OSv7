...
$lang['gmail_api_token_registered'] = '%BRANDING_NAME% 现在被授权代表您的 gmail 帐户发送电子邮件。您可以关闭此窗口。';
...
$lang['config_allow_customers_to_pay_suspended_sales_online'] = '允许客户在线支付暂停的销售费用';

$lang['config_work_order_all_warranty_repairs_are_free'] = '所有保修维修都是免费的';

$lang['config_disable_appointment_emails'] = '禁用预约电子邮件';
$lang['config_allow_zero_price_location_price_overrides'] = '允许零价格位置价格覆盖';


$lang['config_hide_zendesk_chat'] = '隐藏人工智能支持聊天机器人';
$lang['config_advanced_sales_interface'] = '高级销售界面';
$lang['config_advanced_receiving_interface'] = '高级接收接口';

$lang['config_do_not_allow_charge_to_store_account_greater_than_amount_due'] = '不允许向商店账户收取超过应付金额的费用';
$lang['config_customer_with_negative_store_account_balances_must_keep_balance_at_or_below_0'] = '商店账户余额为负的客户必须将余额保持在 0 或以下';

$lang['config_shogo_desc'] = '%BRANDING_NAME% 现在通过我们的合作伙伴 Shogo 与所有主要会计软件集成。这将在未来取代我们当前的 quickbooks 集成。我们的合作伙伴允许更灵活的集成，还包括购买和自定义帐户映射';
$lang['config_hide_price_rule_on_receipt'] = '隐藏收据上的价格规则名称';
$lang['common_work_order_terms'] = '工作订单条款和条件';
$lang['config_show_email_of_company_on_receipt'] = '收据上显示公司的电子邮件';

$lang['config_update_base_unit_price_from_units'] = '根据单价更新基本销售价格';
$lang['config_take_inventory_out_of_system_when_creating_updating_work_order'] = '创建/更新工作订单时将库存从系统中取出';


$lang['config_sms_mobile_tel_alias'] = '移动电话号码';
$lang['config_sms_mobile_tel_username'] = '手机号码 用户名';
$lang['config_sms_mobile_tel_password'] = '手机密码';

$lang['config_show_weight_and_dim_on_receipt'] = '在收据上显示重量和尺寸';

$lang['config_do_not_suspended_receipt_created_by_someone_else'] = '不允许员工取消他人创建的暂停销售';

$lang['config_always_enable_location_selling_price_during_receiving'] = '收货时始终启用位置销售价格更新';
$lang['config_inventory_post_date_is_always_sale_date'] = '库存日期始终是销售日期';
$lang['config_not_used'] = '未使用';
$lang['config_price_weight'] = '价格/重量';
$lang['config_scale_0'] = '自定义格式';
$lang['config_override_fulfillment_sheet_title'] = '覆盖履行表标题';
$lang['config_show_line_item_sales_person_on_receipt'] = '显示收货单销售人员';
$lang['config_hide_parts_and_labor_items_on_receipt'] = '隐藏收据上的零件和人工项目';
$lang['config_show_debit_payment_option_when_using_integrated_credit_card_processing'] = '进行集成信用卡处理时显示借记卡付款类型';
$lang['config_shopify_step_size'] = 'Shopify 非整数产品的步长';
$lang['config_do_not_format_phone_number'] = '不要格式化电话号码';

$lang['config_hide_name_on_qr_codes'] = '隐藏二维码上的名称';
$lang['config_hide_price_on_qr_codes'] = '在二维码上隐藏王子';
$lang['config_qr_code_price_include_tax'] = '二维码含税';
$lang['config_do_not_allow_store_payment_more_than_balance'] = '不允许商店付款超过其余额';
$lang['config_require_payment_against_store_account_charge'] = '要求付款以商店账户收费';
$lang['config_enable_giftcard_security'] = '启用礼品卡安全';

$lang['config_default_tier'] = '默认层';
...
$lang['config_auto_tier_ranges'] = '自动分层范围';
$lang['config_add_auto_tier_range'] = '添加自动等级范围';
$lang['config_auto_tier_min_sales'] = '最低终身销售量';
$lang['config_auto_tier_max_sales'] = '最大终身销售量';
$lang['config_enable_auto_tiering'] = '启用自动分层';
$lang['config_always_show_expire_date_in_recv'] = '接收时始终显示到期日期';
$lang['config_rename_left_menu'] = '重命名左侧菜单';
$lang['config_show_item_description_on_work_order_sheet'] = '在工作订单表上显示项目描述';
?>
