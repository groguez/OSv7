...
abstract class Datacapusbprocessor extends Creditcardprocessor
{
	...
	function __construct($controller,$secure_device_emv, $secure_device_non_emv)
	{
		...
		if ($reg_info->secure_device_emv)
		{
			$this->secure_device_emv = $reg_info->secure_device_emv;
		}
		
		if ($reg_info->secure_device_non_emv)
		{
			$this->secure_device_non_emv = $reg_info->secure_device_non_emv;
		}
