...
function redisErrorFunction($errno, $errstr, $errfile, $errline) 
{
    // is the error E_WARNING?
    if ($errno === E_WARNING) 
	{
        ...
        if ($errstr == 'session_start(): Failed to acquire session lock') 
		{
...
class MY_Session extends CI_Session 
{
	public function __construct(array $params = array())
	{
		...
		if (is_on_phppos_host())
		{
			...
			set_error_handler('redisErrorFunction');
