	...
	*/
	...
	function clone_item_kit($item_kit_id)
	{
		...
		$item_kit_data = array(
			...
			'non_profit_sale'=>$data['item_kit_info']->non_profit_sale ? $data['item_kit_info']->non_profit_sale : 0,
	...
	function save_item_kit_pricing($item_kit_id = -1)
	{
	    ...
	    $item_kit_data = array(
	        ...
	        'dynamic_cost_price' => $this->input->post('dynamic_cost_price') ? 1 : 0,
	        'dynamic_unit_price' => $this->input->post('dynamic_unit_price') ? 1 : 0, // Added fields
	    );
	...
	function save($item_kit_id=-1)
	{
		...
		if ($this->input->post('limited_sales_quantity') !== '')
		{
			$item_kit_data['limited_sales_quantity'] = intval($this->input->post('limited_sales_quantity'));
		}
		else
		{
			$item_kit_data['limited_sales_quantity'] = NULL;
		}
