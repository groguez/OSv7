...
function create_breadcrumb()
{
	...
	elseif($ci->uri->segment(1) == 'reports')
	{
		...
		elseif($ci->uri->segment(3) == 'inventory_aging')
		{
			$return.=create_report_breadcrumb(lang('reports_inventory_aging'));
		}
		...
		elseif($ci->uri->segment(3) == 'new_customers' || $ci->uri->segment(3) == 'detailed_new_customers')
		{
        ...
        else if ($ci->uri->segment(3) == 'tax_by_payments_received') {
            $return .= create_report_breadcrumb(lang('reports_tax_by_payments_received'));
        }
        else if ($ci->uri->segment(3) == 'best_selling_attribute') {
            $return .= create_report_breadcrumb(lang('reports_items_best_selling_attribute'));
        }
        else if ($ci->uri->segment(3) == 'agying_reports') {
            $return .= create_report_breadcrumb(lang('reports_agying_reports'));
        }
	}
	...
	elseif ($ci->uri->segment(1) == 'sales')
	{
		...
		if($ci->uri->segment(2) == 'sell_giftcard')
		{
