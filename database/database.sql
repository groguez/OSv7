...
--
-- Table structure for table `phppos_auto_tier_ranges`
--
...
--
-- Dumping data for table `phppos_auto_tier_ranges`
--

LOCK TABLES `phppos_auto_tier_ranges` WRITE;
/*!40000 ALTER TABLE `phppos_auto_tier_ranges` DISABLE KEYS */;
/*!40000 ALTER TABLE `phppos_auto_tier_ranges` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `phppos_categories_tier_prices`
--
...
CREATE TABLE `phppos_categories_tier_prices` (
  ...
  KEY `phppos_items_tier_prices_ibfk_2` (`category_id`),
  CONSTRAINT `phppos_categories_tier_prices_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `phppos_categories` (`id`),
  CONSTRAINT `phppos_categories_tier_prices_ibfk_2` FOREIGN KEY (`tier_id`) REFERENCES `phppos_price_tiers` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `phppos_categories_tier_prices`
--

LOCK TABLES `phppos_categories_tier_prices` WRITE;
/*!40000 ALTER TABLE `phppos_categories_tier_prices` DISABLE KEYS */;
/*!40000 ALTER TABLE `phppos_categories_tier_prices` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `phppos_customer_subscriptions` (
  ...
  `payment_option` int(1) NOT NULL DEFAULT '1' COMMENT '1 - credit card\r\n2 - store account',
...
CREATE TABLE `phppos_customers` (
  ...
  `deleted` int(1) NOT NULL DEFAULT '0',
  `hide_from_deleted` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `valor_vault_id` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
  ...
  KEY `hide_from_deleted` (`hide_from_deleted`),
...
--
-- Table structure for table `phppos_customers_phone_numbers`
--
...
CREATE TABLE `phppos_customers_phone_numbers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `phone_customer_id` int(11) DEFAULT NULL,
  `additional_phone_number` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `additional_phone_number` (`additional_phone_number`),
  KEY `phone_customer_id` (`phone_customer_id`),
  CONSTRAINT `phppos_customers_phone_numbers_ibfk_1` FOREIGN KEY (`phone_customer_id`) REFERENCES `phppos_customers` (`person_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `phppos_customers_phone_numbers`
--

LOCK TABLES `phppos_customers_phone_numbers` WRITE;
/*!40000 ALTER TABLE `phppos_customers_phone_numbers` DISABLE KEYS */;
/*!40000 ALTER TABLE `phppos_customers_phone_numbers` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER enforce_phone_format_on_insert
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER enforce_phone_format_on_update
...
INSERT INTO `phppos_employees` VALUES (1,'admin','439a6de57d475c1a0ba9bcb1c39f0af6',0,0,1,NULL,0.0000000000,'',0.0000000000,0,0,NULL,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,0,NULL,NULL);
...
CREATE TABLE `phppos_expenses` (
  ...
  CONSTRAINT `phppos_expenses_ibfk_6` FOREIGN KEY (`register_id`) REFERENCES `phppos_registers` (`register_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `phppos_giftcards` (
  ...
  `giftcard_pin` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `phppos_inventory` (
  ...
  KEY `idx_inventory_composite` (`trans_items`,`location_id`,`item_variation_id`,`trans_id`),
...
CREATE TABLE `phppos_item_kits` (
  ...
  `non_profit_sale` int(11) NOT NULL DEFAULT '0',
  `limited_sales_quantity` int(11) DEFAULT NULL,
  `dynamic_cost_price` tinyint(1) DEFAULT '0',
  `dynamic_unit_price` tinyint(1) DEFAULT '0',
...
CREATE TABLE `phppos_items` (
  ...
  `non_profit_sale` int(11) NOT NULL DEFAULT '0',
  `ecommerce_first_variation_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `limited_sales_quantity` int(11) DEFAULT NULL,
  `disable_related_sales_prompt` tinyint(1) NOT NULL DEFAULT '0',
  `disable_related_receivings_prompt` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`item_id`),
  UNIQUE KEY `item_number` (`item_number`),
  UNIQUE KEY `product_id` (`product_id`),
...
CREATE TABLE `phppos_locations` (
  ...
  `valor_appid` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `valor_channel_override` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `currency_rate_id` int(10) DEFAULT NULL,
  `do_not_allow_below_cost` tinyint(1) DEFAULT NULL,
  `do_not_allow_out_of_stock_items_to_be_sold` tinyint(1) DEFAULT NULL,
  `do_not_allow_items_to_go_out_of_stock_when_transfering` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`location_id`),
  KEY `deleted` (`deleted`),
...
INSERT INTO `phppos_locations` VALUES (1,'Default',NULL,NULL,NULL,'123 Nowhere street','555-555-5555','','no-reply@example.com',NULL,NULL,NULL,NULL,'0','','America/New_York','','0',NULL,'','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'','','','','0','','','','','','',0,'','',NULL,1,0,'USD','','100',NULL,NULL,0,NULL,NULL,'',NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,'',NULL,'previous_day',0,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,0,'','','',0,0,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,'2023-07-25 19:36:32',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `phppos_migrations` VALUES (20230905148209);
...
CREATE TABLE `phppos_register_log_audit` (
  ...
  KEY `expense_id` (`expense_id`),
  CONSTRAINT `phppos_register_log_audit_ibfk_1` FOREIGN KEY (`expense_id`) REFERENCES `phppos_expenses` (`id`),
...
CREATE TABLE `phppos_registers` (
  ...
  `secure_device_emv` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `secure_device_non_emv` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `valor_appkey` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `phppos_registers` VALUES (1,1,'Default',NULL,NULL,0,NULL,NULL,NULL,0,NULL,NULL,NULL);
...
--
-- Table structure for table `phppos_related_items`
--
...
--
-- Dumping data for table `phppos_related_items`
--

LOCK TABLES `phppos_related_items` WRITE;
/*!40000 ALTER TABLE `phppos_related_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `phppos_related_items` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `phppos_sales` (
  ...
  `ecommerce_financial_status` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ecommerce_reason` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `store_account_payment` int(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `phppos_sales_item_kits` (
  ...
  `discount_percent` decimal(15,3) NOT NULL DEFAULT '0.000',
  `flat_discount_amount` decimal(23,10) NOT NULL DEFAULT '0.0000000000',
  ...
  `sold_by_employee_id_2` int(10) DEFAULT NULL,
  `custom_field_1_value` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `custom_field_2_value` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `custom_field_3_value` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `custom_field_4_value` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  KEY `supplier_id` (`supplier_id`),
  KEY `sold_by_employee_id_2` (`sold_by_employee_id_2`),
  KEY `custom_field_1_value` (`custom_field_1_value`),
  KEY `custom_field_2_value` (`custom_field_2_value`),
  KEY `custom_field_3_value` (`custom_field_3_value`),
  KEY `custom_field_4_value` (`custom_field_4_value`),
  ...
  CONSTRAINT `phppos_sales_item_kits_ibfk_5` FOREIGN KEY (`sold_by_employee_id_2`) REFERENCES `phppos_employees` (`person_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `phppos_sales_items` (
  ...
  `discount_percent` decimal(15,3) NOT NULL DEFAULT '0.000',
  `flat_discount_amount` decimal(15,10) NOT NULL DEFAULT '0.0000000000',
  `commission` decimal(23,10) NOT NULL DEFAULT '0.0000000000',
  `subtotal` decimal(23,10) NOT NULL DEFAULT '0.0000000000',
  `tax` decimal(23,10) NOT NULL DEFAULT '0.0000000000',
  `total` decimal(23,10) NOT NULL DEFAULT '0.0000000000',
  ...
  KEY `serialnumber` (`serialnumber`(255)),
  KEY `sold_by_employee_id_2` (`sold_by_employee_id_2`),
  KEY `custom_field_1_value` (`custom_field_1_value`),
  KEY `custom_field_2_value` (`custom_field_2_value`),
  KEY `custom_field_3_value` (`custom_field_3_value`),
  ...
  CONSTRAINT `phppos_sales_items_ibfk_10` FOREIGN KEY (`sold_by_employee_id_2`) REFERENCES `phppos_employees` (`person_id`),
...
CREATE TABLE `phppos_sales_payments` (
  ...
  `auth_code` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `ref_no` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `tran_no` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `cc_token` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `acq_ref_data` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `process_data` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
  `entry_method` varchar(255) COLLATE utf8_unicode_ci DEFAULT '',
...
-- Dump completed on 2025-06-16 22:47:21
